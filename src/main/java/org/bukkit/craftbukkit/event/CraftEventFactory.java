...
import org.bukkit.entity.ArrowPoison;
...
import net.minecraft.server.ExplosionB;
...
public class CraftEventFactory {
    ...
    public static final DamageSource ANVIL = CraftDamageSource.copyOf(DamageSource.ANVIL);
    ...
    public static EntityShootBowEvent callEntityShootBowEventFORCE(EntityLiving who, ItemStack itemstack, EntityArrowForce entityArrow, float force) {
        LivingEntity shooter = (LivingEntity) who.getBukkitEntity();
        CraftItemStack itemInHand = CraftItemStack.asCraftMirror(itemstack);
        ArrowForce arrow = (ArrowForce) entityArrow.getBukkitEntity();
    ...
    public static EntityShootBowEvent callEntityShootBowEventSPEED(EntityLiving who, ItemStack itemstack, EntityArrowSpeed entityArrow, float force) {
        LivingEntity shooter = (LivingEntity) who.getBukkitEntity();
        CraftItemStack itemInHand = CraftItemStack.asCraftMirror(itemstack);
        ArrowSpeed arrow = (ArrowSpeed) entityArrow.getBukkitEntity();
    ...
    public static EntityShootBowEvent callEntityShootBowEventPOISON(EntityLiving who, ItemStack itemstack, EntityArrowPoison entityArrow, float force) {
        LivingEntity shooter = (LivingEntity) who.getBukkitEntity();
        CraftItemStack itemInHand = CraftItemStack.asCraftMirror(itemstack);
        ArrowPoison arrow = (ArrowPoison) entityArrow.getBukkitEntity();
    ...
    public static EntityShootBowEvent callEntityShootBowEventLENTEUR(EntityLiving who, ItemStack itemstack, EntityArrowLenteur entityarrow, float force) {
        LivingEntity shooter = (LivingEntity) who.getBukkitEntity();
        CraftItemStack itemInHand = CraftItemStack.asCraftMirror(itemstack);
        ArrowLenteur arrow = (ArrowLenteur) entityarrow.getBukkitEntity();
    ...
    public static EntityShootBowEvent callEntityShootAMMO(EntityLiving who, ItemStack itemstack, EntityAmmo entityarrow, float force) {
        LivingEntity shooter = (LivingEntity) who.getBukkitEntity();
        CraftItemStack itemInHand = CraftItemStack.asCraftMirror(itemstack);
        ArrowLenteur arrow = (ArrowLenteur) entityarrow.getBukkitEntity();
    ...
    private static EntityDamageEvent handleEntityDamageEvent(Entity entity, DamageSource source, Map<DamageModifier, Double> modifiers, Map<DamageModifier, Function<? super Double, Double>> modifierFunctions) {
        if (source.isExplosion()) {
            ...
            return event;
                ...
                EntityDamageEvent event = callEvent(new EntityDamageByBlockEvent(null, entity.getBukkitEntity(), DamageCause.FALLING_BLOCK, modifiers, modifierFunctions));
                if (!event.isCancelled()) {
                    event.getEntity().setLastDamageCause(event);
                }
                return event;
    ...
    public static CreeperRedPowerEvent callCreeperRedPowerEvent(Entity creeper, Entity lightning, CreeperRedPowerEvent.PowerCause cause) {
        CreeperRedPowerEvent event = new CreeperRedPowerEvent((CreeperRed) creeper.getBukkitEntity(), (LightningStrike) lightning.getBukkitEntity(), cause);
        creeper.getBukkitEntity().getServer().getPluginManager().callEvent(event);
        return event;
    }
    public static CreeperAquaPowerEvent callCreeperAquaPowerEvent(Entity creeper, Entity lightning, CreeperAquaPowerEvent.PowerCause cause) {
    	CreeperAquaPowerEvent event = new CreeperAquaPowerEvent((CreeperAqua) creeper.getBukkitEntity(), (LightningStrike) lightning.getBukkitEntity(), cause);
        creeper.getBukkitEntity().getServer().getPluginManager().callEvent(event);
        return event;
    }
    ...
    public static BlockIgniteEvent callBlockIgniteEvent(World world, int x, int y, int z, ExplosionB explosion) {
        org.bukkit.World bukkitWorld = world.getWorld();
        org.bukkit.entity.Entity igniter = explosion.source == null ? null : explosion.source.getBukkitEntity();
