...
public class CraftBlockProjectileSource implements BlockProjectileSource {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        else if (KetaPearl.class.isAssignableFrom(projectile)) {
            launch = new EntityKetaPearl(world, null);
            launch.setPosition(iposition.getX(), iposition.getY(), iposition.getZ());
        }
        ...
        else if (ArrowForce.class.isAssignableFrom(projectile)) {
            launch = new EntityArrowForce(world, iposition.getX(), iposition.getY(), iposition.getZ());
            ((EntityArrowForce) launch).fromPlayer = 1;
            ((EntityArrowForce) launch).projectileSource = this;
        }
        else if (ArrowSpeed.class.isAssignableFrom(projectile)) {
            launch = new EntityArrowSpeed(world, iposition.getX(), iposition.getY(), iposition.getZ());
            ((EntityArrowSpeed) launch).fromPlayer = 1;
            ((EntityArrowSpeed) launch).projectileSource = this;
        }
        else if (ArrowPoison.class.isAssignableFrom(projectile)) {
            launch = new EntityArrowPoison(world, iposition.getX(), iposition.getY(), iposition.getZ());
            ((EntityArrowPoison) launch).fromPlayer = 1;
            ((EntityArrowPoison) launch).projectileSource = this;
        }
        else if (ArrowLenteur.class.isAssignableFrom(projectile)) {
            launch = new EntityArrowLenteur(world, iposition.getX(), iposition.getY(), iposition.getZ());
            ((EntityArrowLenteur) launch).fromPlayer = 1;
            ((EntityArrowLenteur) launch).projectileSource = this;
        }
        else if (Ammo.class.isAssignableFrom(projectile)) {
            launch = new EntityArrow(world, iposition.getX(), iposition.getY(), iposition.getZ());
            ((EntityAmmo) launch).fromPlayer = 1;
            ((EntityAmmo) launch).projectileSource = this;
        } 
