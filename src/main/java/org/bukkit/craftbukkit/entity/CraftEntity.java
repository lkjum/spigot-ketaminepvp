...
import net.minecraft.server.EntityArrowPoison;
...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, Entity entity) {
        ...
        if (entity instanceof EntityLiving) {
            ...
            // Water Animals
                ...
                if (entity instanceof EntityAnimal) {
                    ...
                    else if (entity instanceof EntityRoadrunner) { return new CraftLlama(server, (EntityRoadrunner) entity); }
                    else if (entity instanceof EntityParrot) { return new CraftParrot(server, (EntityParrot) entity); }
                    else if (entity instanceof EntityBear) { return new CraftBear(server, (EntityBear) entity); }
                    else if (entity instanceof EntityPhoenix) { return new CraftPhoenix(server, (EntityPhoenix) entity); }
                    else if (entity instanceof EntityDofin) { return new CraftDauphin(server, (EntityDofin) entity); }
                ...
                // Monsters
                    ...
                    if (entity instanceof EntityCrackos) {
                        if (entity instanceof EntityPigZombie) { return new CraftPigZombie(server, (EntityPigZombie) entity); }
                        else { return new CraftCrackos(server, (EntityCrackos) entity); }
                    }
                    else if (entity instanceof EntityCreeper) { return new CraftCreeper(server, (EntityCreeper) entity); }
                    else if (entity instanceof EntityCreeperRed) { return new CraftCreeperRed(server, (EntityCreeperRed) entity); }
                    else if (entity instanceof EntityCreeperAqua) { return new CraftCreeperAqua(server, (EntityCreeperAqua) entity); }
        ...
        else if (entity instanceof EntityArrowForce) { return new CraftArrowForce(server, (EntityArrowForce) entity); }
        else if (entity instanceof EntityArrowSpeed) { return new CraftArrowSpeed(server, (EntityArrowSpeed) entity); }
        else if (entity instanceof EntityArrowPoison) { return new CraftArrowPoison(server, (EntityArrowPoison) entity); }
        else if (entity instanceof EntityArrowLenteur) { return new CraftArrowLenteur(server, (EntityArrowLenteur) entity); }
        else if (entity instanceof EntityAmmo) { return new CraftAmmo(server, (EntityAmmo) entity); }
            ...
            else if (entity instanceof EntityKetaPearl) { return new CraftKetaPearl(server, (EntityKetaPearl) entity); }
        ...
        else if (entity instanceof EntityGrappin) { return new CraftGrappin(server, (EntityGrappin) entity); }
            ...
            else if (entity instanceof EntityMinecartKetaChest) { return new CraftMinecartKetaChest(server, (EntityMinecartKetaChest) entity); }
        ...
        else if (entity instanceof EntityAquaTNTPrimed) { return new CraftAquaTNTPrimed(server, (EntityAquaTNTPrimed) entity); }
    ...
    public boolean isOnGround() {
        ...
        else if (entity instanceof EntityArrowForce) {
            return ((EntityArrowForce) entity).isInGround();
        }
        else if (entity instanceof EntityArrowSpeed) {
            return ((EntityArrowSpeed) entity).isInGround();
        }
        else if (entity instanceof EntityArrowPoison) {
            return ((EntityArrowPoison) entity).isInGround();
        }
        else if (entity instanceof EntityArrowLenteur) {
            return ((EntityArrowLenteur) entity).isInGround();
        }
        else if (entity instanceof EntityAmmo) {
            return ((EntityAmmo) entity).isInGround();
        }
