...
public enum EntityType {
    ...
    ARROWFORCE("arrowForce", ArrowForce.class, 25),
    ARROWSPEED("arrowSpeed", ArrowSpeed.class, 26),
    ARROWPOISON("arrowPoison", ArrowPoison.class, 27),
    ARROWLENTEUR("arrowLenteur", ArrowLenteur.class, 28),
    /**
     * A flying snowball.
     */
    ...
    AQUAPRIMED_TNT("AquaPrimedTnt", AquaTNTPrimed.class, 704),
    /**
    ...
    AMMO("Ammo", Ammo.class, 23),
    KETA_PEARL("ThrownKetapearl", KetaPearl.class, 24),
    /**
     * @see CommandMinecart
     */
    ...
    CREEPERRED("CreeperRed", CreeperRed.class, 69),
    CRACKOS("Crackos", Crackos.class, 70),   
    CREEPERAQUA("CreeperAqua", CreeperAqua.class, 71),
    ...
    LLAMA("Llama", Llama.class, 102),
    PARROT("parrot", Parrot.class, 103),  
    BEAR("Ours", Bear.class, 104),
    PHOENIX("Phoenix", Phoenix.class, 105),
    DAUPHIN("Dauphin", Dauphin.class, 106),  
    
    //BEAR("Ours", Bear.class, 102),
    
    VILLAGER("Villager", Villager.class, 120),
    ENDER_CRYSTAL("EnderCrystal", EnderCrystal.class, 200),
    
    MINECART_KETA_CHEST("MinecartKetaChest", StorageMinecart.class, 43),
    ...
    GRAPPIN(null, Grappin.class, -1, false),
    /**
     * A bolt of lightning.
     * <p>
