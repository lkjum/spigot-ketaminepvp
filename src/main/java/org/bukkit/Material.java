...
import org.bukkit.material.BicarFurnace;
import org.bukkit.material.CokeBurner;
import org.bukkit.material.IronChest;
import org.bukkit.material.TitaneChest;
...
public enum Material {
    ...
    KETAMINERAI(605),
    //fioleMeth(606),
    KETACASQUE(607, 1, 440),
    KETAPLAQUE(608, 1, 640),
    KETAPANTS(609, 1, 600),
    KETABOOTS(610, 1, 520),
    CRYSTALMETH(611),
    TRACE2C(612, 64),
    KETAPIOCHE(613, 1, 2048),
    KETAPELLE(614, 1, 2048),
    KETAXE(615, 1, 2048),
    KETASWORD(616, 1, 2048),
    KETAFAUX(617, 1, 2048),
    COKE_HELMET(618, 1, 550),
    COKE_CHESTPLATE(619, 1, 800),
    COKE_LEGS(620, 1, 750),
    COKE_BOOTS(621, 1, 650),
    COKE_PICKAXE(622, 1, 4096),
    COKE_SHOVEL(623, 1, 4096),
    COKE_AXE(624, 1, 4096),
    COKE_SWORD(625, 1, 4096),
    COKE_HOE(626, 1, 4096),
    PIPE(627),
    PIPECRACK(628, 8),
    IRON_NUGGET(629),
    BITCOIN_HELMET(630, 1, 715),
    BITCOIN_CHESTPLATE(631, 1, 1040),
    BITCOIN_LEGGINGS(632, 1, 975),
    BITCOIN_BOOTS(633, 1, 875),
    BITCOIN(634),
    BITCOIN_PICKAXE(635, 1, 10000),
    BITCOIN_SHOVEL(636, 1, 10000),
    BITCOIN_AXE(637, 1, 10000),
    BITCOIN_SWORD(638, 1, 10000),
    BITCOIN_HOE(639, 1, 10000),
    DARK_BITCOIN(640),
    DARK_CHESTPLATE(641, 1, 160),
    DARK_SWORD(642, 1, 50000),
    JOINT(643, 64),
    POTION_HASTE(644, 2),
    BOTMILK(645, 2),
    POTION_HASTE_2(646, 2),
    ACID(647, 64),
    SUNSHINE(648, 64),
    GOBLIN(649, 64),
    TRACE2K(650, 64),
    ...
    SON(210, 64),
    BLOCKACID(211, 64),
    IRON_CHEST(213, IronChest.class),
    BICAR_FURNACE(214, BicarFurnace.class),
    LIT_BICAR_FURNACE(215, BicarFurnace.class),
    COKE_BURNER(216, CokeBurner.class),
    LIT_COKE_BURNER(217, CokeBurner.class),
    FLYING_MUSHROOM(218), 
    TITANE_ORE(220,64),
    TITANE_BLOCK(221,64),
    DEALORE(222,64),    
    TITANE_CHEST(223, TitaneChest.class),
    PAVOTS(224),
    HEROINE_BLOCK(225, 64),
    KETA_BREWING(226, MaterialData.class),
    FLYING_MUSHROOM_BLOCK(219, Mushroom.class),
    POTION_FALL(671, 2),
    PETROLE(672, 64),
    AMMO(673, 32),
    AK(674, 1),
    TITANE(676, 64),
    TITANE_HELMET(677,1, 135),
    TITANE_CHESTPLATE(678,1, 135),
    TITANE_LEGS(679,1, 135),
    TITANE_BOOTS(680,1, 135),
    TITANE_PICKAXE(681,1, 11000),
    TITANE_SHOVEL(682,1, 11000),
    TITANE_AXE(683,1, 11000),
    TITANE_SWORD(684,1, 11000),
    TITANE_HOE(685,1, 11000),
    TITANE_NUGGET(686,64),
    FIOLE5L(687, 64),
    PAVOT_SEEDS(688, 64),
    PAVOT(689, 64),
    PAVOT_STACK(690, 64),
    HEROINE(691, 64),
    HEROINE_STACK(692, 64),
    KETA_BREWER_ITEM(693, 64),
    KETA_CHEST_MINECART(694, 1),
    
    DRUGS_WORK(229),
    LAVA_SPONGE(230),
    CROUTE_TERRESTRE(231, 64),
    //CROUTE_DOOR_BLOCK(232, 64),
    SPACE_CAKE(232, 64, Cake.class),
    COKE_LADDER(233, Ladder.class),
    SON_1(235, 64),
    SON_2(236, 64),
    SON_3(237, 64),   
    BITCOIN_HALF(695),
    ...
    DARK_HELMET(700, 1,160),
    DARK_LEGGINGS(701, 1,160),
    DARK_BOOTS(702, 1,160),
    
    DARK_PICKAXE(703, 1, 10000),
    DARK_SHOVEL(704, 1, 10000),
    DARK_AXE(705, 1, 10000),
    DARK_HOE(706,1, 10000),
    MDMA(707, 64),
    MD_HELMET(708, 1, 150),
    MD_CHESTPLATE(709, 1, 150),
    MD_LEGGINGS(710, 1, 150),
    MD_BOOTS(711, 1, 150),
    MD_PICKAXE(712,1,11500),
    MD_AXE(713,1,11500),
    MD_SHOVEL(714,1,11500),
    MD_SWORD(715,1,11500),
    MD_HOE(716,1,11500),
    MD_POUDRE(717, 64),
    PLAQUE(718, 64),
    SPACE_CAKE_ITEM(719, 1),
    ...
    TIKETA_HELMET(725, 1, 160),
    TIKETA_CHESTPLATE(726,1, 160),
    TIKETA_LEGS(727,1, 160),
    TIKETA_BOOTS(728,1, 160),
    
    TICOKE_HELMET(729,1, 170),
    TICOKE_CHESTPLATE(730,1, 170),
    TICOKE_LEGS(731,1, 170),
    TICOKE_BOOTS(732,1, 170),
    
    TIMDMA_HELMET(733,1, 180),
    TIMDMA_CHESTPLATE(734,1, 180),
    TIMDMA_LEGS(735,1, 180),
    TIMDMA_BOOTS(736,1, 180),
    
    TISUP_HELMET(737,1, 200),
    TISUP_CHESTPLATE(738,1, 200),
    TISUP_LEGS(739,1, 200),
    TISUP_BOOTS(740,1, 200),
    
    TISUP_PICKAXE(741,1, 17000),
    TISUP_AXE(742,1, 17000),
    TISUP_SHOVEL(743,1, 17000),
    
    TISUP_SWORD(744,1,17000),
    TIKETA_SWORD(745,1,12000),
    TICOKE_SWORD(746,1,13000),
    TIMDMA_SWORD(747,1,15000),
    SUP_NUGGET(748,64),
    TAZ_GOLD(749,64),
    TAZ_SUPERMAN(750,64),
    TAZ_DOMINO(751,64),
    TAZ_MITSU(752,64),
    SPACE_COOCKIE(753,64),
    BEURRE_MARRAKECH(754,64),
    ITEM_MULTI(755,1),
    ITEM_FARMING(756,1,10000),
    ITEM_FARMOUZ(757,1,10000),
    KETAPPLE(758,64),
    CYBOULETTES(239, MaterialData.class),
    PURPLES(240),
    CYBOULETTE(759,64),
    PURPLE(760,64),
    PURPLE_SEEDS(761,64),
    PURPLE_TETE(762,64),
    ITEM_FARMSEED(763,1,10000),
    GUN(764,1),
    ITEM_MULTIPICK(765,1,50000),
    KETA_PEARL(766,16),
    FLYING_MUSHROOM_STEW(767,1),
    IBOGAS(241),
    IBOGAINE(768,64),
    IBOGA_ROOT(769,64),
    IBOGA_FRUIT(770,64),
    ITEM_IBOGA_POTION(771, 2),
    SALVIAX40(772,64),
    SALVIA_SEEDS(773,64),
    SALVIA_FLOWER(774,64),
    SALVIAS(242),
    MAGMA(243,64),
    END_BRICKS(244,64),
    PURPUR_BLOCK(245,64),
    CROUTE_DOOR_BLOCK(246, Door.class),
    CROUTE_DOOR(775,64),
    OBSI_DOOR_BLOCK(247, Door.class),
    OBSI_DOOR(776,64),
    DISENCHANT_BLOCK(248,64),
    HEAL_BLOCK(249,64),
    WEED_PLANT_BASE(250),
    WEED_PLANT_TOP(251),
    SHEITAN_ORE(252,64),
    SHEITAN_BLOCK(253,64),
    OBSIRED(254,64),
    WEED_PLANT_ITEM(777,64),
    SHEITANITE(778,64),
    DAGUE_DIABLE(779,1,8000),
    DOUILLE(780,64),
    FEATHER_PHOENIX(781,64),
    ARROWFORCE(784,64),
    ARROWSPEED(785,64),
    ARROWPOISON(786,64),
    ARROWLENTEUR(787,64),
    ...
    LEANVIDE(788,64),
    FIN2LEAN(789,1),
    PHENERGAN_PILLS(790,64),
    TUSSIPAX_PILLS(791,64),
    SPRITE(792,64),
    ACETONE(793,64),
    GRAPPIN(794,1)
    ;
    ...
    public boolean isSolid() {
        ...
        switch (this) {
        	case CROUTE_DOOR_BLOCK:
        	case OBSI_DOOR_BLOCK:
            case STONE:
            case GRASS:
            case DIRT:
            case COBBLESTONE:
            ...
            case SON_3:
            case BICAR_FURNACE:
            case LIT_BICAR_FURNACE:
            case COKE_BURNER:
            case LIT_COKE_BURNER:
            case TITANE_BLOCK:
            case TITANE_ORE:
            case DEALORE:
            case IRON_CHEST:
            case FLYING_MUSHROOM_BLOCK:
            case TITANE_CHEST:
            case HEROINE_BLOCK:
            case KETA_BREWING:
            case CROUTE_TERRESTRE:
            case LAVA_SPONGE:
            case DRUGS_WORK:
            case SPACE_CAKE:
            case MAGMA:
