...
public class Mushroom extends MaterialData {
    ...
    public Mushroom(Material shroom) {
        super(shroom);
        Validate.isTrue(shroom == Material.HUGE_MUSHROOM_1 || shroom == Material.HUGE_MUSHROOM_2 || shroom == Material.FLYING_MUSHROOM_BLOCK, "Not a mushroom!");
    }
    ...
    public Mushroom(int type, byte data){
        super(type, data);
        Validate.isTrue(type == Material.HUGE_MUSHROOM_1.getId() || type == Material.HUGE_MUSHROOM_2.getId()  || type == Material.FLYING_MUSHROOM_BLOCK.getId(), "Not a mushroom!");
    }
