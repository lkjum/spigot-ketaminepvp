...
public class ActivationRange
{
    ...
    public static boolean checkEntityImmunities(Entity entity)
    {
        ...
        if ( entity instanceof EntityLiving )
        {
            ...
            if (entity instanceof EntityCreeperRed && ((EntityCreeperRed) entity).cn()) { // isExplosive
                return true;
            }
            if (entity instanceof EntityCreeperAqua && ((EntityCreeperAqua) entity).cn()) { // isExplosive
                return true;
            }
        }
        return false;
