...
public class BlockIronChest extends BlockContainer {
    ...
    protected BlockIronChest(int i) {
        super(Material.WOOD);
        this.j(this.blockStateList.getBlockData().set(BlockIronChest.FACING, EnumDirection.NORTH));
        this.b = i;
    ...
    public IBlockData getPlacedState(World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2, int i, EntityLiving entityliving) {
        return this.getBlockData().set(BlockIronChest.FACING, entityliving.getDirection());
    }
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata, EntityLiving entityliving, ItemStack itemstack) {
        ...
        iblockdata = iblockdata.set(BlockIronChest.FACING, enumdirection);
        ...
        if (itemstack.hasName()) {
            ...
            if (tileentity instanceof TileEntityIronChest) {
                ((TileEntityIronChest) tileentity).a(itemstack.getName());
            }
        }
    ...
    public IBlockData e(World world, BlockPosition blockposition, IBlockData iblockdata) {
        if (world.isClientSide) {
            ...
            EnumDirection enumdirection = (EnumDirection) iblockdata.get(BlockIronChest.FACING);
            ...
            if (block != this && block1 != this) {
                ...
                if (block2 == this || block3 == this) {
                    ...
                    if (block2 == this) {
                        enumdirection1 = (EnumDirection) iblockdata3.get(BlockIronChest.FACING);
                    } else {
                        enumdirection1 = (EnumDirection) iblockdata4.get(BlockIronChest.FACING);
                    }
                ...
                if (block == this) {
                    enumdirection2 = (EnumDirection) iblockdata1.get(BlockIronChest.FACING);
                } else {
                    enumdirection2 = (EnumDirection) iblockdata2.get(BlockIronChest.FACING);
                }
    ...
    public IBlockData f(World world, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        if (enumdirection != null) {
            return iblockdata.set(BlockIronChest.FACING, enumdirection.opposite());
        } else {
            EnumDirection enumdirection2 = (EnumDirection) iblockdata.get(BlockIronChest.FACING);
            ...
            return iblockdata.set(BlockIronChest.FACING, enumdirection2);
        }
    }
    ...
    public ITileInventory f(World world, BlockPosition blockposition) {
        ...
        if (!(tileentity instanceof TileEntityIronChest)) {
            ...
            Object object = (TileEntityIronChest) tileentity;
    ...
    public int a(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, EnumDirection enumdirection) {
        if (!this.isPowerSource()) {
            ...
            if (tileentity instanceof TileEntityIronChest) {
                i = ((TileEntityIronChest) tileentity).l;
            }
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        return this.getBlockData().set(BlockIronChest.FACING, enumdirection);
    }

    public int toLegacyData(IBlockData iblockdata) {
        return ((EnumDirection) iblockdata.get(BlockIronChest.FACING)).a();
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, new IBlockState[] { BlockIronChest.FACING});
    }
}
