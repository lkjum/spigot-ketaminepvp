...
public class EntityTypes {
    ...
    static {
        ...
        a(EntityAmmo.class, "Ammo", 23);
        a(EntityKetaPearl.class, "ThrownKetapearl", 24);
        a(EntityArrowForce.class, "arrowForce", 25);
        a(EntityArrowSpeed.class, "arrowSpeed", 26);
        a(EntityArrowPoison.class, "arrowPoison", 27);
        a(EntityArrowLenteur.class, "arrowLenteur", 28);
        ...
        a(EntityCreeperRed.class, "CreeperRed", 69, 13908239, 13919503);
        a(EntityCrackos.class, "Crackos", 70, 9819151, 61813913);
        a(EntityCreeperAqua.class, "CreeperAqua", 71, 44975, 2243405);
        ...
        a(EntityRoadrunner.class, "Llama", 102, 15656192, 1570061);
        a(EntityParrot.class, "parrot", 103, 894731, 16711680);    
        a(EntityBear.class, "polarbear", 104, 15198183, 1447446); 
        a(EntityPhoenix.class, "enjoypenix", 105, 16711680, 15656192); 
        a(EntityDofin.class, "dofinmalin", 106, 7375001, 44975); 
        
        a(EntityVillager.class, "Villager", 120, 5651507, 12422002);
        a(EntityEnderCrystal.class, "EnderCrystal", 200);
        
        a(EntityMinecartKetaChest.class, EntityMinecartAbstract.EnumMinecartType.KETA_CHEST.b(), 703);
        a(EntityAquaTNTPrimed.class, "PrimedAquaTnt", 704);
    }
