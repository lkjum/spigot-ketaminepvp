...
public class SlotBicarFurnaceResult extends Slot {

    private EntityHuman a;
    private int b;

    public SlotBicarFurnaceResult(EntityHuman entityhuman, IInventory iinventory, int i, int j, int k) {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            TileEntityBicarFurnace furnace = ((TileEntityBicarFurnace) this.inventory);
        ...
        /*if (itemstack.getItem() == Items.BITCOIN)
        {
            this.a.b(AchievementList.bitcoinToYou);
        }
        if (itemstack.getItem() == Items.TITANE)
        {
            this.a.b(AchievementList.titaneToYou);
        }*/
