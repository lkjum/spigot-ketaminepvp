...
public class ItemTraceCoke extends ItemFood {

	private int meta;
    public ItemTraceCoke(int meta) {
    	super(0, 0, false);
        this.meta = meta;
    	//c(32);
    ...
    public ItemStack b(ItemStack itemstack, World world, EntityHuman entityhuman) {
    	...
    	//if(meta ==1) {
            ...
            entityhuman.addEffect(new MobEffect(MobEffectList.FASTER_MOVEMENT.id, 6000, 1));
            entityhuman.addEffect(new MobEffect(MobEffectList.INCREASE_DAMAGE.id, 200, 1 ));
