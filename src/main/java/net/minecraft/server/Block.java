...
public class Block {
    ...
    public static final Block.StepSound son = new Block.StepSound("son", 1.0F, 1.0F)  {
    ...
    public void wasExploded(World world, BlockPosition blockposition, ExplosionB explosion) {}
    ...
    public boolean a(ExplosionB explosion) {
        return true;
    }
    ...
    public static void S() {
        ...
        a(7, "bedrock", (new BlockBedrock(Material.BEDROCK)).x().b(6000000.0F).a(Block.i).c("bedrock").K().a(CreativeModeTab.b));
        ...
        a(49, "obsidian", (new BlockObsidian()).c(25.0F).b(2000.0F).a(Block.i).c("obsidian"));
        a(50, "torch", (new BlockTorch()).c(0.0F).a(0.9375F).a(Block.f).c("torch"));
        a(51, "fire", (new BlockFire()).c(0.0F).a(1.0F).a(Block.l).c("fire").K());
        a(52, "mob_spawner", (new BlockMobSpawner()).c(5.0F).b(2000.0F).a(Block.j).c("mobSpawner").K());
        ...
        a(71, "iron_door", (new BlockDoor(Material.ORE)).c(10.0F).b(20.0F).a(Block.j).c("doorIron").K());
        ...
        a(200, "ketaore", (new BlockOre()).c(4.0F).b(6.0F).a(0.25F).a(Block.i).c("ketaore"));
        a(201, "cokeore", (new BlockOre()).c(4.0F).b(6.0F).a(0.25F).a(Block.i).c("cokeore"));
        a(202, "bitcoin_ore", (new BlockOre()).c(4.0F).b(6.0F).a(0.25F).a(Block.i).c("bitcoin_ore"));
        a(205, "bicarbonate_ore", (new BlockOre()).c(3.0F).b(5.0F).a(0.25F).a(Block.i).c("bicarbonate_ore"));
        a(203, "coke_block", (new Block(Material.ORE, MaterialMapColor.G)).c(5.0F).b(10.0F).a(Block.j).c("coke_block").a(CreativeModeTab.b));
        a(204, "keta_block", (new Block(Material.ORE, MaterialMapColor.G)).c(5.0F).b(10.0F).a(Block.j).c("keta_block").a(CreativeModeTab.b));
        a(206, "bicar_block", (new Block(Material.ORE, MaterialMapColor.G)).c(5.0F).b(10.0F).a(Block.j).c("bicar_block").a(CreativeModeTab.b));
        
        a(207, "weed", (new BlockWeed()).c("weed"));
        a(208, "coca", (new BlockCoca()).c("coca"));
        
        a(209, "invisible", (new BlockInvisible(Material.AIR, false)).c("invisible").a(CreativeModeTab.b));
        a(210, "son", (new BlockSon(Material.CLAY)).c("son").a(CreativeModeTab.f).a(son));
        a(211, "blockAcid", (new BlockAcid()).c(1.5F).b(6.0F).c("blockAcid").a(CreativeModeTab.b));
        a(213, "iron_chest", (new BlockIronChest(0)).c(1.5F).a(Block.f).c("chest"));
        a(214, "bicar_furnace", (new BlockBicarFurnace(false)).c(3.5F).c("bicar_furnace").a(CreativeModeTab.c));
        a(215, "lit_bicar_furnace", (new BlockBicarFurnace(true)).c(3.5F).a(Block.i).a(0.875F).c("lit_bicar_furnace"));
        //a(61, "furnace", (new BlockFurnace(false)).c(3.5F).a(Block.i).c("furnace").a(CreativeModeTab.c));
        //a(62, "lit_furnace", (new BlockFurnace(true)).c(3.5F).a(Block.i).a(0.875F).c("furnace"));
        a(216, "coke_burner", (new BlockCokeBurner(false)).c(3.5F).c("coke_burner").a(CreativeModeTab.c));
        a(217, "lit_coke_burner", (new BlockCokeBurner(true)).c(3.5F).a(Block.i).a(0.0875F).c("lit_coke_burner"));
        Block blockChamp = (new BlockMushroom()).c(0.0F).a(Block.h).a(0.125F).c("mushroom");
        a(218, "flying_mushroom", blockChamp);
        a(219, "flying_mushroom_block", (new BlockHugeMushroom(Material.WOOD, MaterialMapColor.l, block3)).c(0.2F).a(Block.f).c("mushroom"));
        //a(219, "flying_mushroom_block", (new BlockMushroom()).c(1.5F).b(6.0F).c("flying_mushroom_block"));
        a(220, "titane_ore", (new Block(Material.ORE, MaterialMapColor.G)).c(5.0F).b(10.0F).a(Block.i).c("titane_ore"));
        a(221, "titane_block", (new Block(Material.ORE, MaterialMapColor.G)).c(5.0F).b(10.0F).a(Block.i).c("titane_block"));
        
        Block dealOre = (new BlockDealOre().c(4.5F).b(5.0F).a(Block.i).c("dealOre"));
        a(222, "dealOre", dealOre);
        
        a(223, "titane_chest", (new BlockTitaneChest(0)).c(2.0F).a(Block.f).c("chest"));
        a(226, "keta_brewing", (new BlockKetaBrewer()).c(1.25F).b(0.5F).c("keta_brewing")); 
        a(224, "pavot", (new BlockPavot()).c("pavot"));
        a(225, "heroine_block", (new Block(Material.ORE, MaterialMapColor.G)).c(5.0F).b(10.0F).a(Block.i).c("heroine_block"));
        a(229, "drugs_work", (new BlockDrugsWork()).c(2.5F).a(Block.i).c("drugs_work"));
        a(230, "lava_sponge", (new BlockLavaSponge()).c(0.6F).a(Block.h).c("lava_sponge"));
        a(231, "croute_terrestre", (new BlockCroute()).c(50.0F).b(2000.0F).a(Block.i).c("croute_terrestre"));
        a(233, "coke_ladder", (new BlockLadderCoke()).c(0.4F).a(Block.o).c("coke_ladder"));
        a(232, "space_cake", (new BlockSpaceCake()).c(0.5F).a(Block.l).c("space_cake").K());
        a(235, "son_1", (new BlockSon1(Material.CLAY)).c("son_1").a(CreativeModeTab.f).a(BlockStep.son));
        a(236, "son_2", (new BlockSon2(Material.CLAY)).c("son_2").a(CreativeModeTab.f).a(BlockStep.son));
        a(237, "son_3", (new BlockSon3(Material.CLAY)).c("son_3").a(CreativeModeTab.f).a(BlockStep.son));
        a(240, "purples", (new BlockPurple()).c("purple"));
        a(239, "cyboulettes", (new BlockCyboul()).c(0.0F).a(Block.h).c("cyboulette").K());
        a(241, "ibogas", (new BlockIboga()).c("iboga"));
        a(242, "salvias", (new BlockSalvia()).c("salvia"));
        a(243, "magma", (new Block(Material.ORE, MaterialMapColor.G)).c(0.5F).a(0.2F).a(Block.i).c("magma").a(CreativeModeTab.b));
        a(244, "end_bricks", (new Block(Material.ORE, MaterialMapColor.G)).c(0.8F).a(Block.i).c("end_bricks").a(CreativeModeTab.b));
        a(245, "purpur_block", (new Block(Material.ORE, MaterialMapColor.G)).c(1.5F).b(10.0F).a(Block.i).c("purpur_block").a(CreativeModeTab.b));
        a(246, "croute_door_block", (new BlockDoor(Material.CROUTE)).c(3.0F).b(20.0F).a(Block.j).c("doorCroute").K());
        a(247, "obsi_door_block", (new BlockDoor(Material.OBSI)).c(3.0F).b(15.0F).a(Block.j).c("doorObsi").K());
        a(248, "disenchant_block", (new Block(Material.ORE, MaterialMapColor.G)).c(10.0F).a(Block.i).c("disenchant_block").a(CreativeModeTab.b));
        a(249, "heal_block", (new Block(Material.ORE, MaterialMapColor.G)).c(10.0F).b(10.0F).a(Block.i).c("heal_block").a(CreativeModeTab.b));
        
        a(250, "weed_plant_base", (new BlockWeedPlantBase()).c("weed_plant_base"));
        a(251, "weed_plant_top", (new BlockWeedPlant()).c("weed_plant_top"));     
        a(252, "sheitan_ore", (new BlockOre(MaterialMapColor.K)).c(4.0F).b(5.0F).a(1.0F).a(Block.i).c("sheitan_ore"));
        a(253, "sheitan_block", (new Block(Material.ORE, MaterialMapColor.K)).c(5.0F).b(5.0F).a(Block.j).c("sheitan_block").a(CreativeModeTab.b)); 
        a(254, "obsired", (new BlockObsired()).c(15.0F).a(Block.i).c("obsired"));
        a(255, "aquatnt", (new BlockAquaTNT()).c(0.0F).a(Block.h).c("aquatnt"));
	...
	public double getBlockHardness(World worldIn, BlockPosition pos) {
		// TODO Auto-generated method stub
		return 0;
	}
}
