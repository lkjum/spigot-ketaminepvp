...
public class ItemFood extends Item {
    ...
    public ItemStack b(ItemStack itemstack, World world, EntityHuman entityhuman) {
        ...
        ItemStack i = new ItemStack(Items.TRACE2C);
        ItemStack j = new ItemStack(Items.TRACE2K);
        ItemStack k = new ItemStack(Items.TRACE2SPEED);
        ItemStack l = new ItemStack(Items.JOINT);
        if (itemstack == i || itemstack == j || itemstack == k || itemstack == l) {
