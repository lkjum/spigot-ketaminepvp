    ...
    public static class WorldGenWitchHut extends WorldGenRegistration.WorldGenScatteredPiece {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (!this.a(world, structureboundingbox, 0)) {
                ...
                this.a(world, Blocks.FLOWER_POT.getBlockData().set(BlockFlowerPot.CONTENTS, BlockFlowerPot.EnumFlowerPotContents.FLYING_MUSHROOM), 1, 3, 5, structureboundingbox);
                this.a(world, Blocks.CRAFTING_TABLE.getBlockData(), 3, 2, 6, structureboundingbox);
                this.a(world, Blocks.IRON_CHEST.getBlockData(), 4, 2, 6, structureboundingbox);
