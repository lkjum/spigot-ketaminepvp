...
public class TileEntityBicarFurnace extends TileEntityContainer implements IUpdatePlayerListBox, IWorldInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.m : "container.bicar_furnace";
    }
    ...
    public void c() {
        boolean flag = (this.w() == Blocks.LIT_BICAR_FURNACE); // CraftBukkit - SPIGOT-844 - Check if furnace block is lit using the block instead of burn time // PAIL: Rename
        boolean flag1 = false;
        ...
        if (!this.world.isClientSide) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                BlockBicarFurnace.a(this.isBurning(), this.world, this.position);
    ...
    public boolean b(int i, ItemStack itemstack) {
        return i == 2 ? false : (i != 1 ? true : isFuel(itemstack) || SlotBicarFurnaceFuel.c_(itemstack));
    }

    public int[] getSlotsForFace(EnumDirection enumdirection) {
        return enumdirection == EnumDirection.DOWN ? TileEntityBicarFurnace.f : (enumdirection == EnumDirection.UP ? TileEntityBicarFurnace.a : TileEntityBicarFurnace.g);
    }
    ...
    public Container createContainer(PlayerInventory playerinventory, EntityHuman entityhuman) {
        return new ContainerBicarFurnace(playerinventory, this);
    }
