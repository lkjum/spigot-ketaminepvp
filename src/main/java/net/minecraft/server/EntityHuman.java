...
public abstract class EntityHuman extends EntityLiving {
    ...
    public EntityGrappin grappened;
    // CraftBukkit start
        ...
        if (this.isInvulnerable(damagesource)) {
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                if (false && f == 0.0F) { // CraftBukkit - Don't filter out 0 damage
                    ...
                    if (entity instanceof EntityArrowForce && ((EntityArrowForce) entity).shooter != null) {
                        entity = ((EntityArrowForce) entity).shooter;
                    }
                    if (entity instanceof EntityArrowSpeed && ((EntityArrowSpeed) entity).shooter != null) {
                        entity = ((EntityArrowSpeed) entity).shooter;
                    }
                    if (entity instanceof EntityArrowPoison && ((EntityArrowPoison) entity).shooter != null) {
                        entity = ((EntityArrowPoison) entity).shooter;
                    }
                    if (entity instanceof EntityArrowLenteur && ((EntityArrowLenteur) entity).shooter != null) {
                        entity = ((EntityArrowLenteur) entity).shooter;
                    }

                    if (entity instanceof EntityAmmo && ((EntityAmmo) entity).shooter != null) {
                        entity = ((EntityAmmo) entity).shooter;
                    }
    ...
    public void attack(Entity entity) {
        if (entity.aD()) {
            if (!entity.l(this)) {
                ...
                int i = b0 + EnchantmentManager.az((EntityLiving) this);
...
//Potion Fall fix Spigot Lk
    private MobEffect potioneffect;
    public void e(float f, float f1) 
    {
    	this.potioneffect = this.getEffect(MobEffectList.FALL);
