...
public class ContainerCokeBurner extends Container {
    ...
    public CraftInventoryView getBukkitView() {
        ...
        CraftInventoryCokeBurner inventory = new CraftInventoryCokeBurner((TileEntityCokeBurner) this.furnace);
        bukkitEntity = new CraftInventoryView(this.player.player.getBukkitEntity(), inventory, this);
        return bukkitEntity;
    }
    // CraftBukkit end

    public ContainerCokeBurner(PlayerInventory playerinventory, IInventory iinventory) {
        this.furnace = iinventory;
        this.a(new Slot(iinventory, 0, 56, 17));
        //this.a(new Slot(iinventory, 0, 36, 17));
        this.a((Slot) (new SlotBurnerFuel(iinventory, 1, 56, 53)));
       // this.a((Slot) (new SlotBurnerFuel(iinventory, 3, 36, 53)));
        this.a((Slot) (new SlotCokeBurnerResult(playerinventory.player, iinventory, 2, 116, 35)));
    ...
    public ItemStack b(EntityHuman entityhuman, int i) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (i == 2) {
                ...
                } else if (TileEntityCokeBurner.isFuel(itemstack1)) {
