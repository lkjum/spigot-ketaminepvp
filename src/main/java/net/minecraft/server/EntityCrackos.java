...
public class EntityCrackos extends EntityMonster {

    protected static final IAttribute a = (new AttributeRanged((IAttribute) null, "zombie.spawnReinforcements", 0.0D, 0.0D, 1.0D)).a("Spawn Reinforcements Chance");
    private static final UUID b = UUID.fromString("B9766B59-9566-4402-BC1F-2EE2A276D836");
    private static final AttributeModifier c = new AttributeModifier(EntityCrackos.b, "Baby speed boost", 0.5D, 1);
    ...
    public EntityCrackos(World world) {
        super(world);
    ...
    protected void initAttributes() {
        ...
        this.getAttributeMap().b(EntityCrackos.a).setValue(this.random.nextDouble() * 0.10000000149011612D);
    }
    ...
    public void setBaby(boolean flag) {
        ...
        if (this.world != null && !this.world.isClientSide) {
            ...
            attributeinstance.c(EntityCrackos.c);
            if (flag) {
                attributeinstance.b(EntityCrackos.c);
            }
        }
    ...
    public boolean damageEntity(DamageSource damagesource, float f) {
        if (super.damageEntity(damagesource, f)) {
            ...
            if (entityliving != null && this.world.getDifficulty() == EnumDifficulty.HARD && (double) this.random.nextFloat() < this.getAttributeInstance(EntityCrackos.a).getValue()) {
                int i = MathHelper.floor(this.locX);
                int j = MathHelper.floor(this.locY);
                int k = MathHelper.floor(this.locZ);
                EntityCrackos entityzombie = new EntityCrackos(this.world);
                ...
                for (int l = 0; l < 50; ++l) {
                    ...
                    if (World.a((IBlockAccess) this.world, new BlockPosition(i1, j1 - 1, k1)) && this.world.getLightLevel(new BlockPosition(i1, j1, k1)) < 10) {
                        ...
                        if (!this.world.isPlayerNearby((double) i1, (double) j1, (double) k1, 7.0D) && this.world.a(entityzombie.getBoundingBox(), (Entity) entityzombie) && this.world.getCubes(entityzombie, entityzombie.getBoundingBox()).isEmpty() && !this.world.containsLiquid(entityzombie.getBoundingBox())) {
                            ...
                            this.getAttributeInstance(EntityCrackos.a).b(new AttributeModifier("Zombie reinforcement caller charge", -0.05000000074505806D, 0));
                            entityzombie.getAttributeInstance(EntityCrackos.a).b(new AttributeModifier("Zombie reinforcement callee charge", -0.05000000074505806D, 0));
                            break;
                        }
                    }
                }
    ...
    protected void getRareDrop() {
        ...
        case 1:
            this.a(Items.HEROINE, 1);
            break;

        case 2:
            this.a(Items.WEED_SEEDS, 1);
        }
    ...
    public GroupDataEntity prepare(DifficultyDamageScaler difficultydamagescaler, GroupDataEntity groupdataentity) {
        ...
        if (object == null) {
            object = new EntityCrackos.GroupDataZombie(this.world.random.nextFloat() < 0.05F, this.world.random.nextFloat() < 0.05F, (EntityCrackos.SyntheticClass_1) null);
        }

        if (object instanceof EntityCrackos.GroupDataZombie) {
        	EntityCrackos.GroupDataZombie entityzombie_groupdatazombie = (EntityCrackos.GroupDataZombie) object;
        ...
        if (this.random.nextFloat() < f * 0.05F) {
            this.getAttributeInstance(EntityCrackos.a).b(new AttributeModifier("Leader zombie bonus", this.random.nextDouble() * 0.25D + 0.5D, 0));
    ...
    /*public void die(DamageSource damagesource) {
        ...
        if (damagesource.getEntity() instanceof EntityCreeperRed && !(this instanceof EntityPigZombie) && ((EntityCreeperRed) damagesource.getEntity()).isPowered() && ((EntityCreeper) damagesource.getEntity()).cp()) {
            ((EntityCreeperRed) damagesource.getEntity()).cq();
            // CraftBukkit start
    ...
    class GroupDataZombie implements GroupDataEntity {
        ...
        GroupDataZombie(boolean flag, boolean flag1, EntityCrackos.SyntheticClass_1 entityzombie_syntheticclass_1) {
            this(flag, flag1);
        }
    }
}
