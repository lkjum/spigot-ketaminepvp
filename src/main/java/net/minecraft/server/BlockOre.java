...
public class BlockOre extends Block {
        	...
        	(this == Blocks.DIAMOND_ORE ? Items.DIAMOND : 
        		(this == Blocks.LAPIS_ORE ? Items.DYE : 
        			(this == Blocks.EMERALD_ORE ? Items.EMERALD :
        				(this == Blocks.EMERALD_ORE ? Items.EMERALD : 
        					(this == Blocks.COKE_ORE ? Items.COCAINE : 
        						(this == Blocks.SHEITAN_ORE ? Items.SHEITANITE : 
        						(this == Blocks.QUARTZ_ORE ? Items.QUARTZ : Item.getItemOf(this))))))));
    }

    public int a(Random random) {
    	if (this == Blocks.COKE_ORE) {
    ...
    public int getExpDrop(World world, IBlockData iblockdata, int i) {
        if (this.getDropType(iblockdata, world.random, i) != Item.getItemOf(this)) {
            ...
            else if (this == Blocks.SHEITAN_ORE) {
                j = MathHelper.nextInt(world.random, 1, 3);
            }else if (this == Blocks.COKE_ORE) {
                j = MathHelper.nextInt(world.random, 2, 5);
            }
