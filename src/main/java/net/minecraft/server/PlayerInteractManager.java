    ...
    public boolean breakBlock(BlockPosition blockposition) {
        ...
        if (this.player instanceof EntityPlayer) {
            ...
            boolean isSwordNoBreak = this.gamemode.d() && this.player.bA() != null && this.player.bA().getItem() instanceof ItemSword
            		|| this.gamemode.d() && this.player.bA() != null && this.player.bA().getItem() instanceof ItemDagueDiable;
        ...
        if (false && this.gamemode.d() && this.player.bA() != null && this.player.bA().getItem() instanceof ItemSword
        		|| false && this.gamemode.d() && this.player.bA() != null && this.player.bA().getItem() instanceof ItemDagueDiable) {
            return false;
        } else {
            IBlockData iblockdata = this.world.getType(blockposition);
