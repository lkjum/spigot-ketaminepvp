...
public class Material {
    ...
    //public static final Material PETROLE = (new Material(MaterialMapColor.i)).g();
    ...
    public static final Material LAVA_SPONGE = new Material(MaterialMapColor.f);
    public static final Material CROUTE = (new Material(MaterialMapColor.m)).f();
    public static final Material OBSI = (new Material(MaterialMapColor.m)).f();
    public static final Material BEDROCK = (new Material(MaterialMapColor.m)).n();
    public static final Material AQUATNT = (new Material(MaterialMapColor.n)).g().s();
