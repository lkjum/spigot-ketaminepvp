...
public class EntityTrackerEntry {
    ...
    public void track(List<EntityHuman> list) {
        ...
        if (this.m % this.c == 0 || this.tracker.ai || this.tracker.getDataWatcher().a()) {
            ...
            if (this.tracker.vehicle == null) {
                ...
                if (this.m > 0 || this.tracker instanceof EntityArrowForce) {
                    if (j1 >= -128 && j1 < 128 && k1 >= -128 && k1 < 128 && l1 >= -128 && l1 < 128 && this.v <= 400 && !this.x && this.y == this.tracker.onGround) {
                        if ((!flag || !flag1) && !(this.tracker instanceof EntityArrowForce)) {
                            if (flag) {
                                object = new PacketPlayOutEntity.PacketPlayOutRelEntityMove(this.tracker.getId(), (byte) j1, (byte) k1, (byte) l1, this.tracker.onGround);
                            } else if (flag1) {
                                object = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.tracker.getId(), (byte) l, (byte) i1, this.tracker.onGround);
                ...
                if (this.m > 0 || this.tracker instanceof EntityArrowSpeed) {
                    if (j1 >= -128 && j1 < 128 && k1 >= -128 && k1 < 128 && l1 >= -128 && l1 < 128 && this.v <= 400 && !this.x && this.y == this.tracker.onGround) {
                        if ((!flag || !flag1) && !(this.tracker instanceof EntityArrowSpeed)) {
                            if (flag) {
                                object = new PacketPlayOutEntity.PacketPlayOutRelEntityMove(this.tracker.getId(), (byte) j1, (byte) k1, (byte) l1, this.tracker.onGround);
                            } else if (flag1) {
                                object = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.tracker.getId(), (byte) l, (byte) i1, this.tracker.onGround);
                ...
                if (this.m > 0 || this.tracker instanceof EntityArrowPoison) {
                    if (j1 >= -128 && j1 < 128 && k1 >= -128 && k1 < 128 && l1 >= -128 && l1 < 128 && this.v <= 400 && !this.x && this.y == this.tracker.onGround) {
                        if ((!flag || !flag1) && !(this.tracker instanceof EntityArrowPoison)) {
                            if (flag) {
                                object = new PacketPlayOutEntity.PacketPlayOutRelEntityMove(this.tracker.getId(), (byte) j1, (byte) k1, (byte) l1, this.tracker.onGround);
                            } else if (flag1) {
                                object = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.tracker.getId(), (byte) l, (byte) i1, this.tracker.onGround);
                ...
                if (this.m > 0 || this.tracker instanceof EntityArrowLenteur) {
                    if (j1 >= -128 && j1 < 128 && k1 >= -128 && k1 < 128 && l1 >= -128 && l1 < 128 && this.v <= 400 && !this.x && this.y == this.tracker.onGround) {
                        if ((!flag || !flag1) && !(this.tracker instanceof EntityArrowLenteur)) {
                            if (flag) {
                                object = new PacketPlayOutEntity.PacketPlayOutRelEntityMove(this.tracker.getId(), (byte) j1, (byte) k1, (byte) l1, this.tracker.onGround);
                            } else if (flag1) {
                                object = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.tracker.getId(), (byte) l, (byte) i1, this.tracker.onGround);
                ...
                if (this.m > 0 || this.tracker instanceof EntityAmmo) {
                    if (j1 >= -128 && j1 < 128 && k1 >= -128 && k1 < 128 && l1 >= -128 && l1 < 128 && this.v <= 400 && !this.x && this.y == this.tracker.onGround) {
                        if ((!flag || !flag1) && !(this.tracker instanceof EntityArrow)) {
                            if (flag) {
                                object = new PacketPlayOutEntity.PacketPlayOutRelEntityMove(this.tracker.getId(), (byte) j1, (byte) k1, (byte) l1, this.tracker.onGround);
    ...
    private Packet c() {
        ...
        if (this.tracker instanceof EntityItem) {
        ...
        else if (this.tracker instanceof EntityGrappin) {
            EntityHuman entityhuman = ((EntityGrappin) this.tracker).owner;

            return new PacketPlayOutSpawnEntity(this.tracker, 107, entityhuman != null ? entityhuman.getId() : this.tracker.getId());
        }
        ...
        else if (this.tracker instanceof EntityArrowForce) {
            Entity entity = ((EntityArrowForce) this.tracker).shooter;

            return new PacketPlayOutSpawnEntity(this.tracker, 100, entity != null ? entity.getId() : this.tracker.getId());
        } 
        else if (this.tracker instanceof EntityArrowSpeed) {
            Entity entity = ((EntityArrowSpeed) this.tracker).shooter;

            return new PacketPlayOutSpawnEntity(this.tracker, 101, entity != null ? entity.getId() : this.tracker.getId());
        } 
        else if (this.tracker instanceof EntityArrowPoison) {
            Entity entity = ((EntityArrowPoison) this.tracker).shooter;

            return new PacketPlayOutSpawnEntity(this.tracker, 102, entity != null ? entity.getId() : this.tracker.getId());
        } 
        else if (this.tracker instanceof EntityArrowLenteur) {
            Entity entity = ((EntityArrowLenteur) this.tracker).shooter;

            return new PacketPlayOutSpawnEntity(this.tracker, 103, entity != null ? entity.getId() : this.tracker.getId());
        } 
        else if (this.tracker instanceof EntityAmmo) {
            Entity entity = ((EntityAmmo) this.tracker).shooter;

            return new PacketPlayOutSpawnEntity(this.tracker, 104, entity != null ? entity.getId() : this.tracker.getId());
        } 
        ...
        else if (this.tracker instanceof EntityKetaPearl) {
            return new PacketPlayOutSpawnEntity(this.tracker, 105);
        }
            ...
            }else if (this.tracker instanceof EntityAquaTNTPrimed) {
                return new PacketPlayOutSpawnEntity(this.tracker, 106);
            } 
