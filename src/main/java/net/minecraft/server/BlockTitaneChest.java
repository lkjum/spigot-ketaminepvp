...
public class BlockTitaneChest extends BlockContainer {

    public static final BlockStateDirection FACING = BlockStateDirection.of("facing", (Predicate) EnumDirection.EnumDirectionLimit.HORIZONTAL);
    public final int b;

    protected BlockTitaneChest(int i) {
        super(Material.WOOD);
        this.j(this.blockStateList.getBlockData().set(BlockTitaneChest.FACING, EnumDirection.NORTH));
        this.b = i;
    ...
    public IBlockData getPlacedState(World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2, int i, EntityLiving entityliving) {
        return this.getBlockData().set(BlockTitaneChest.FACING, entityliving.getDirection());
    }
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata, EntityLiving entityliving, ItemStack itemstack) {
        ...
        iblockdata = iblockdata.set(BlockTitaneChest.FACING, enumdirection);
        ...
        if (itemstack.hasName()) {
            ...
            if (tileentity instanceof TileEntityTitaneChest) {
                ((TileEntityTitaneChest) tileentity).a(itemstack.getName());
            }
        }
    ...
    public IBlockData e(World world, BlockPosition blockposition, IBlockData iblockdata) {
        if (world.isClientSide) {
            ...
            EnumDirection enumdirection = (EnumDirection) iblockdata.get(BlockTitaneChest.FACING);
            ...
            if (block != this && block1 != this) {
                ...
                if (block2 == this || block3 == this) {
                    ...
                    if (block2 == this) {
                        enumdirection1 = (EnumDirection) iblockdata3.get(BlockTitaneChest.FACING);
                    } else {
                        enumdirection1 = (EnumDirection) iblockdata4.get(BlockTitaneChest.FACING);
                    }
                ...
                if (block == this) {
                    enumdirection2 = (EnumDirection) iblockdata1.get(BlockTitaneChest.FACING);
                } else {
                    enumdirection2 = (EnumDirection) iblockdata2.get(BlockTitaneChest.FACING);
                }
    ...
    public IBlockData f(World world, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        if (enumdirection != null) {
            return iblockdata.set(BlockTitaneChest.FACING, enumdirection.opposite());
        } else {
            EnumDirection enumdirection2 = (EnumDirection) iblockdata.get(BlockTitaneChest.FACING);
            ...
            return iblockdata.set(BlockTitaneChest.FACING, enumdirection2);
        }
    }
    ...
    public ITileInventory f(World world, BlockPosition blockposition) {
        ...
        if (!(tileentity instanceof TileEntityTitaneChest)) {
            ...
            Object object = (TileEntityTitaneChest) tileentity;
    ...
    public TileEntity a(World world, int i) {
        return new TileEntityTitaneChest();
    }
    ...
    public int a(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, EnumDirection enumdirection) {
        if (!this.isPowerSource()) {
            ...
            if (tileentity instanceof TileEntityTitaneChest) {
                i = ((TileEntityTitaneChest) tileentity).l;
            }
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        return this.getBlockData().set(BlockTitaneChest.FACING, enumdirection);
    }

    public int toLegacyData(IBlockData iblockdata) {
        return ((EnumDirection) iblockdata.get(BlockTitaneChest.FACING)).a();
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, new IBlockState[] { BlockTitaneChest.FACING});
    }
}
