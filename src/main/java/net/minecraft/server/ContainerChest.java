...
public class ContainerChest extends Container {
    ...
    public CraftInventoryView getBukkitView() {
        ...
        if (this.container instanceof PlayerInventory) {
         ...
         /*  else if (this.container instanceof InventoryIronChest) {
                inventory = new org.bukkit.craftbukkit.inventory.CraftInventoryIronChest((InventoryIronChest) this.container);
            }*/
         else {
