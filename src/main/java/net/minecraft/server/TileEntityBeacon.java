...
public class TileEntityBeacon extends TileEntityContainer implements IUpdatePlayerListBox, IInventory {
    ...
    public static final MobEffectList[][] a = new MobEffectList[][] { { MobEffectList.FASTER_MOVEMENT, MobEffectList.FASTER_DIG}, { MobEffectList.RESISTANCE, MobEffectList.FALL}, { MobEffectList.INCREASE_DAMAGE}, { MobEffectList.REGENERATION}};
            ...
            for (i1 = 1; i1 <= 4; this.j = i1++) {
                ...
                for (int k1 = j - i1; k1 <= j + i1 && flag1; ++k1) {
                    for (int l1 = l - i1; l1 <= l + i1; ++l1) {
                        ...
                        if (block != Blocks.EMERALD_BLOCK && block != Blocks.GOLD_BLOCK && block != Blocks.DIAMOND_BLOCK && block != Blocks.IRON_BLOCK && block != Blocks.BICAR_BLOCK && block != Blocks.KETA_BLOCK && block != Blocks.COKE_BLOCK) {
                            flag1 = false;
                            break;
                        }
                    }
    ...
    private int h(int i) {
        if (i >= 0 && i < MobEffectList.byId.length && MobEffectList.byId[i] != null) {
            ...
            return mobeffectlist != MobEffectList.FASTER_MOVEMENT && mobeffectlist != MobEffectList.FASTER_DIG && mobeffectlist != MobEffectList.RESISTANCE && mobeffectlist != MobEffectList.FALL && mobeffectlist != MobEffectList.INCREASE_DAMAGE && mobeffectlist != MobEffectList.REGENERATION ? 0 : i;
        } else {
            return 0;
        }
    }
    ...
    public boolean b(int i, ItemStack itemstack) {
        return itemstack.getItem() == Items.EMERALD || itemstack.getItem() == Items.DIAMOND || itemstack.getItem() == Items.GOLD_INGOT || itemstack.getItem() == Items.IRON_INGOT || itemstack.getItem() == Items.BICARBONATE || itemstack.getItem() == Items.KETAMINERAI || itemstack.getItem() == Items.COCA_STACK;
    }
