...
public class ContainerBicarFurnace extends Container {
    ...
    public CraftInventoryView getBukkitView() {
        ...
        CraftInventoryBicarFurnace inventory = new CraftInventoryBicarFurnace((TileEntityBicarFurnace) this.furnace);
        bukkitEntity = new CraftInventoryView(this.player.player.getBukkitEntity(), inventory, this);
        return bukkitEntity;
    }
    // CraftBukkit end

    public ContainerBicarFurnace(PlayerInventory playerinventory, IInventory iinventory) {
        this.furnace = iinventory;
        this.a(new Slot(iinventory, 0, 56, 17));
        this.a((Slot) (new SlotBicarFurnaceFuel(iinventory, 1, 56, 53)));
        this.a((Slot) (new SlotBicarFurnaceResult(playerinventory.player, iinventory, 2, 116, 35)));
    ...
    public ItemStack b(EntityHuman entityhuman, int i) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (i == 2) {
                ...
                } else if (TileEntityBicarFurnace.isFuel(itemstack1)) {
