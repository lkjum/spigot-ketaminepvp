...
public class FoodMetaData {
	...
	public void a(ItemSmoke itemSmoke, ItemStack itemstack) {
        // CraftBukkit start
        int oldFoodLevel = foodLevel;

        org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, itemSmoke.getNutrition(itemstack) + oldFoodLevel);

        if (!event.isCancelled()) {
            this.eat(event.getFoodLevel() - oldFoodLevel, itemSmoke.getSaturationModifier(itemstack));
        }
	...
	public void a(ItemSnort itemSnort, ItemStack itemstack) {
        int oldFoodLevel = foodLevel;

        org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, itemSnort.getNutrition(itemstack) + oldFoodLevel);

        if (!event.isCancelled()) {
            this.eat(event.getFoodLevel() - oldFoodLevel, itemSnort.getSaturationModifier(itemstack));
        }
