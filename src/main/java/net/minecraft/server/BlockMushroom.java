...
public class BlockMushroom extends BlockPlant implements IBlockFragilePlantElement {
    ...
    public boolean d(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        else if (this == Blocks.FLYING_MUSHROOM) 
        {
            BlockSapling.treeType = TreeType.FLYING_MUSHROOM; // CraftBukkit
            worldgenhugemushroom = new WorldGenHugeMushroom(Blocks.FLYING_MUSHROOM_BLOCK);
        }
