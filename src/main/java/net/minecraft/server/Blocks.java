...
public class Blocks
{
  ...
  public static final Block COKE_LADDER = get("coke_ladder");
  ...
  // Ketamine - register block

  public static final Block KETA_ORE = get("ketaore");
  public static final Block COKE_ORE = get("cokeore");
  public static final Block BICARBONATE_ORE = get("bicarbonate_ore");
  public static final Block BITCOIN_ORE = get("bitcoin_ore");
  
  public static final Block KETA_BLOCK = get("keta_block");
  public static final Block COKE_BLOCK = get("coke_block");
  public static final Block BICAR_BLOCK = get("bicar_block");
  public static final Block WEED = get("weed");
  public static final Block COCA = get("coca");
  public static final Block INVISIBLE = get("invisible");
  public static final Block BLOCKACID = get("blockAcid");
  public static final Block FLYING_MUSHROOM_BLOCK = get("flying_mushroom_block");
  public static final BlockPlant FLYING_MUSHROOM = (BlockPlant)get("flying_mushroom");
  public static final Block BICAR_FURNACE = get("bicar_furnace");
  public static final Block LIT_BICAR_FURNACE = get("lit_bicar_furnace");
  public static final Block COKE_BURNER = get("coke_burner");
  public static final Block LIT_COKE_BURNER = get("lit_coke_burner");
  public static final Block TITANE_ORE = get("titane_ore");
  public static final Block TITANE_BLOCK = get("titane_block");
  public static final Block DEALORE = get("dealOre");
  public static final BlockSon SON = (BlockSon) get("son");
  public static final BlockIronChest IRON_CHEST = (BlockIronChest)get("iron_chest");
  public static final BlockTitaneChest TITANE_CHEST = (BlockTitaneChest)get("titane_chest");
  public static final Block KETA_BREWING = get("keta_brewing");
  public static final Block PAVOTS = get("pavot");
  public static final Block HEROINE_BLOCK = get("heroine_block");
  public static final Block CROUTE_TERRESTRE = get("croute_terrestre");
  public static final Block LAVA_SPONGE = get("lava_sponge");
  //public static final Block DOUBLE_FURNACE = get("double_furnace");
  //public static final Block LIT_DOUBLE_FURNACE = get("lit_double_furnace");
  public static final Block DRUGS_WORK = get("drugs_work");
  public static final Block SPACE_CAKE = get("space_cake");
  public static final Block SON_1 = (BlockSon1)get("son_1");
  public static final Block SON_2 = (BlockSon2)get("son_2");
  public static final Block SON_3 = (BlockSon3)get("son_3");
  public static final Block CROUTE_DOOR_BLOCK = get("croute_door_block");
  public static final Block OBSI_DOOR_BLOCK = get("obsi_door_block");
  public static final Block PURPLES = get("purples");
  public static final Block CYBOULETTES = (BlockCyboul) get("cyboulettes");
  public static final Block IBOGAS = get("ibogas");
  public static final Block SALVIAS = get("salvias");
  public static final Block MAGMA = get("magma");
  public static final Block END_BRICKS = get("end_bricks");
  public static final Block PURPUR_BLOCK = get("purpur_block");  
  public static final Block WEED_PLANT_BASE = get("weed_plant_base");
  public static final Block WEED_PLANT_TOP = get("weed_plant_top");  
  public static final Block SHEITAN_BLOCK = get("sheitan_block");
  public static final Block SHEITAN_ORE = get("sheitan_ore");
  public static final Block OBSIRED = get("obsired"); 
  public static final Block HEAL_BLOCK = get("heal_block");
  public static final Block DISENCHANT_BLOCK = get("disenchant_block"); 
  public static final Block AQUATNT = get("aquatnt");
