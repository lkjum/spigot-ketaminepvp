...
public class ExplosionB {
    ...
    public ExplosionB(World world, Entity entity, double d0, double d1, double d2, float f, boolean flag, boolean flag1) {
        this.world = world;
        this.source = entity;
            ...
            if (!entity.aW()) {
                ...
                if (d7 <= 1.0D) {
                    ...
                    if (d11 != 0.0D) {
                        ...
                        if (!wasDamaged && !(entity instanceof EntityAquaTNTPrimed || entity instanceof EntityFallingBlock) && !entity.forceExplosionKnockback) {
                            continue;
                        }
                        // CraftBukkit end
    ...
    public void a(boolean flag) {
        ...
        if (this.size >= 2.0F && this.b) {
        	for (int i = 0; i < 10; i++) {
        		this.world.addParticle(EnumParticle.DRIP_WATER, this.posX, this.posY, this.posZ, 1.0D, 0.0D, 0.0D, new int[0]);
        	}
    ...
    public EntityLiving getSource() {
        ...
        return this.source == null ? null : (this.source instanceof EntityAquaTNTPrimed ? ((EntityAquaTNTPrimed) this.source).getSource() : (this.source instanceof EntityLiving ? (EntityLiving) this.source : (this.source instanceof EntityFireball ? ((EntityFireball) this.source).shooter : null)));
        // CraftBukkit end
    }
