...
public class TileEntityKetaBrewer extends TileEntityContainer implements IUpdatePlayerListBox, IWorldInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.k : "container.keta_brewer";
    }
    ...
    public void c() {
        ...
        if (!this.world.isClientSide) {
            ...
            if (!Arrays.equals(aboolean, this.i)) {
                ...
                if (!(iblockdata.getBlock() instanceof BlockKetaBrewer)) {
                    return;
                }

                for (int i = 0; i < BlockKetaBrewer.HAS_BOTTLE.length; ++i) {
                    iblockdata = iblockdata.set(BlockKetaBrewer.HAS_BOTTLE[i], Boolean.valueOf(aboolean[i]));
                }
    ...
    public int[] getSlotsForFace(EnumDirection enumdirection) {
        return enumdirection == EnumDirection.UP ? TileEntityKetaBrewer.a : TileEntityKetaBrewer.f;
    }
