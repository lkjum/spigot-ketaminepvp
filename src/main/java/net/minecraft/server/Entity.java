...
public abstract class Entity implements ICommandListener {
    ...
    protected void a(MobEffect mobeffect, boolean flag) {
        ...
        if (flag && !this.world.isClientSide) {
            MobEffectList.byId[mobeffect.getEffectId()].a((EntityLiving) this, this.getAttributeMap(), mobeffect.getAmplifier());
            MobEffectList.byId[mobeffect.getEffectId()].b((EntityLiving) this, this.getAttributeMap(), mobeffect.getAmplifier());
        }
    ...
    public float a(ExplosionB explosion, World world, BlockPosition blockposition, IBlockData iblockdata) {
        return iblockdata.getBlock().a(this);
    }
    ...
    public boolean a(ExplosionB explosion, World world, BlockPosition blockposition, IBlockData iblockdata, float f) {
        return true;
    }
