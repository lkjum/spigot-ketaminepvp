...
public abstract class TileEntity {
    ...
    static {
    	...
    	a(TileEntityBicarFurnace.class, "BicarFurnace");
    	a(TileEntityCokeBurner.class, "CokeBurner");
    	//a(TileEntityDoubleFurnace.class, "DoubleFurnace");
    	a(TileEntityIronChest.class, "IronChest");
    	a(TileEntityTitaneChest.class, "TitaneChest");
    	a(TileEntityKetaBrewer.class, "KetaCauldron");
    	//Ketamine PVP Walrus & Lkjum
