...
public class BlockLadderCoke extends Block {

    public static final BlockStateDirection FACING = BlockStateDirection.of("facing", (Predicate) EnumDirection.EnumDirectionLimit.HORIZONTAL);

    protected BlockLadderCoke() {
    ...
    public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        if (iblockdata.getBlock() == this) {
            ...
            switch (BlockLadderCoke.SyntheticClass_1.a[((EnumDirection) iblockdata.get(BlockLadder.FACING)).ordinal()]) {
            case 1:
    ...
    static class SyntheticClass_1 {
        ...
        static {
            try {
                BlockLadderCoke.SyntheticClass_1.a[EnumDirection.NORTH.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
            	BlockLadderCoke.SyntheticClass_1.a[EnumDirection.SOUTH.ordinal()] = 2;
            } catch (NoSuchFieldError nosuchfielderror1) {
                ;
            }

            try {
            	BlockLadderCoke.SyntheticClass_1.a[EnumDirection.WEST.ordinal()] = 3;
            } catch (NoSuchFieldError nosuchfielderror2) {
                ;
            }

            try {
            	BlockLadderCoke.SyntheticClass_1.a[EnumDirection.EAST.ordinal()] = 4;
