...
public class EntityAmmo extends Entity implements IProjectile {
    ...
    public EntityAmmo(World world) {
        super(world);
        this.j = 10.0D;
        this.setSize(0.5F, 0.5F);
    }

    public EntityAmmo(World world, double d0, double d1, double d2) {
        super(world);
        this.j = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityAmmo(World world, EntityLiving entityliving, EntityLiving entityliving1, float f, float f1) {
        super(world);
        this.j = 10.0D;
    ...
    public EntityAmmo(World world, EntityLiving entityliving, float f) {
        super(world);
        this.j = 10.0D;
        this.shooter = entityliving;
        this.projectileSource = (LivingEntity) entityliving.getBukkitEntity(); // CraftBukkit
    ...
    public void t_() {
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                ...
                if (movingobjectposition.entity != null) {
                    ...
                    if (this.shooter == null) {
                        damagesource = DamageSource.ammo(this, this);
                    } else {
                        damagesource = DamageSource.ammo(this, this.shooter);
                    }
                    ...
                    // if (movingobjectposition.entity.damageEntity(damagesource, (float) k)) { // CraftBukkit - moved up
                        ...
                        //this.makeSound("ketamine.shot", 1.0F, 1.2F / (this.random.nextFloat() * 0.2F + 0.9F));
            ...
            {
                this.world.addParticle(EnumParticle.FIREWORKS_SPARK, this.locX + this.motX * (double) jj / 4.0D, this.locY + this.motY * (double) jj / 4.0D, this.locZ + this.motZ * (double) jj / 4.0D, -this.motX, -this.motY + 0.2D, -this.motZ, new int[0]);
                
            }
            this.world.addParticle(EnumParticle.FIREWORKS_SPARK, this.locX + this.motX, this.locY + this.motY, this.locZ + this.motZ, -this.motX, -this.motY, -this.motZ, new int[0]);
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide && this.inGround && this.shake <= 0) {
            // CraftBukkit start
            ItemStack itemstack = new ItemStack(Items.AMMO);
            ...
            if (this.fromPlayer == 1 && !entityhuman.inventory.pickup(new ItemStack(Items.DOUILLE, 1))) {
                flag = false;
            }
