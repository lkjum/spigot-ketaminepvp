...
public class CraftingManager {
    ...
    public CraftingManager() {
       ...
       // (new RecipesWeaponsKeta()).a(this);
        ...
        this.registerShapedRecipe(new ItemStack(Items.PIPE, 1), new Object[] {"IGI", "GIG", "IGI", 'I', Items.IRON_NUGGET, 'G', Blocks.GLASS});
        this.registerShapedRecipe(new ItemStack(Items.FIOLEMETH, 1), new Object[] {"CCC", "GBG", "GGG", 'C', Items.PAIN2C_COOKED, 'G', Blocks.GLASS, 'B', Items.BICARBONATE});
        this.registerShapedRecipe(new ItemStack(Items.FIOLE_COCA, 1), new Object[] {"CCC", "GBG", "GGG", 'C', Items.COCA_STACK, 'G', Blocks.GLASS, 'B', Items.BICARBONATE});
        this.registerShapelessRecipe(new ItemStack(Items.PIPECRACK, 1), new Object[] {Items.PIPE, Items.CRYSTALMETH});
        this.registerShapelessRecipe(new ItemStack(Items.PIPEBEUH, 1), new Object[] {Items.PIPE, Items.BEUH});
        this.registerShapelessRecipe(new ItemStack(Items.PIPETABAC, 1), new Object[] {Items.PIPE, Items.TABAC});
        this.registerShapelessRecipe(new ItemStack(Items.PIPEDMT, 1), new Object[] {Items.PIPE, Items.DMT});
        //this.registerShapedRecipe(new ItemStack(Items.DARK_CHESTPLATE, 1), new Object[] {"# #", "###","###", '#', Items.DARK_BITCOIN});
        this.registerShapedRecipe(new ItemStack(Items.TRACE2C, 1), new Object[] {"#", "#","#", '#', Items.COCAINE});
        this.registerShapedRecipe(new ItemStack(Items.TRACE2SPEED, 1), new Object[] {"#", "#","#", '#', Items.EXTCRACK});
        this.registerShapedRecipe(new ItemStack(Items.TRACE2K, 1), new Object[] {"#", "#","#", '#', Items.EXTKETA});
        //this.registerShapedRecipe(new ItemStack(Items.TONK, 3), new Object[] {"#", "#", "#", '#', Items.PAPER});
        this.registerShapedRecipe(new ItemStack(Items.TONK, 3), new Object[] {"###", '#', Items.PAPER});
        this.registerShapedRecipe(new ItemStack(Items.MASSA, 3), new Object[] {"###", "###", '#', Items.PAPER});
        this.registerShapelessRecipe(new ItemStack(Items.COCA_PILED, 1), new Object[] {Items.COCA_FEUILLES});
        //this.registerShapedRecipe(new ItemStack(Items.JOINT, 1), new Object[] {"#", "M", "T", '#', Items.CANNABIS, 'M', Items.MASSA, 'T', Items.TONK});
        this.registerShapedRecipe(new ItemStack(Blocks.BICAR_FURNACE, 1), new Object[] {"###", "#F#", "###", '#', Items.BICARBONATE, 'F', Blocks.FURNACE});
        this.registerShapedRecipe(new ItemStack(Blocks.COKE_BURNER, 1), new Object[] {"###", "#I#", "###", '#', Items.PAIN2C_COOKED, 'I', Blocks.FURNACE});
        this.registerShapedRecipe(new ItemStack(Items.JOINT, 1), new Object[] {"#CI", '#', Items.MASSA, 'C', Items.CANNABIS, 'I', Items.TONK});
        this.registerShapedRecipe(new ItemStack(Items.DARK_BITCOIN, 1), new Object[] {"###", "###", "###", '#', Items.BITCOIN});
        this.registerShapedRecipe(new ItemStack(Blocks.DEALORE, 3), new Object[] {"###", "#X#", "###", '#', Blocks.BICAR_BLOCK, 'X', Blocks.BITCOIN_ORE});
        this.registerShapedRecipe(new ItemStack(Blocks.HEROINE_BLOCK, 1), new Object[] {"III", "III", "III", 'I', Items.HEROINE_STACK});
        this.registerShapedRecipe(new ItemStack(Blocks.IRON_CHEST, 1), new Object[] {"III", "IiI", "III", 'I', Items.KETAMINERAI, 'i', Blocks.CHEST});
        this.registerShapedRecipe(new ItemStack(Blocks.TITANE_CHEST, 1), new Object[] {"III", "IiI", "III", 'I', Items.TITANE_NUGGET, 'i', Blocks.CHEST});
        this.registerShapedRecipe(new ItemStack(Items.FIOLE5L, 1, 0), new Object[] {" # ", "# #", "###", '#', Blocks.GLASS});
        this.registerShapedRecipe(new ItemStack(Items.FIOLE5L, 1, 1), new Object[] {"CCC", "BFB", " B ", 'C', Items.PAIN2C_COOKED, 'B', Items.BICARBONATE, 'F', new ItemStack(Items.FIOLE5L, 1, 0)});
        this.registerShapedRecipe(new ItemStack(Items.FIOLE5L, 1, 2), new Object[] {"CCC", "BFB", " B ", 'C', Items.COCA_FEUILLES, 'B', Items.BICARBONATE, 'F', new ItemStack(Items.FIOLE5L, 1, 0)});
        this.registerShapedRecipe(new ItemStack(Items.FIOLE5L, 1, 3), new Object[] {"HHH", "BFB", " B ", 'H', Items.PAVOT_STACK, 'B', Items.BICARBONATE, 'F', new ItemStack(Items.FIOLE5L, 1, 0)});
        this.registerShapedRecipe(new ItemStack(Items.KETA_BREWER_ITEM, 1), new Object[] {" B ", "###", 'B', Items.BLAZE_ROD, '#', Items.TITANE_NUGGET});
        this.registerShapedRecipe(new ItemStack(Items.KETA_CHEST_MINECART, 1), new Object[] { "A", "B", "C" , Character.valueOf('A'), Blocks.CHEST, Character.valueOf('B'), Items.MINECART, Character.valueOf('C'), Items.KETAMINERAI});
        this.registerShapedRecipe(new ItemStack(Blocks.CROUTE_TERRESTRE, 1), new Object[] {"###", "###", "###", '#', Blocks.OBSIDIAN});	
        this.registerShapedRecipe(new ItemStack(Items.BITCOIN, 1), new Object[] {"###", "###", "###", '#', Items.BITCOIN_HALF});
        this.registerShapedRecipe(new ItemStack(Blocks.COKE_LADDER, 3), new Object[] { "# #", "###", "# #", Character.valueOf('#'), Items.COCAINE});
        this.registerShapedRecipe(new ItemStack(Items.TITANE_STICK, 1), new Object[] {"#", "#", '#', Items.TITANE});
        this.registerShapedRecipe(new ItemStack(Items.SPACE_COOCKIE, 8), new Object [] {"AAA","BBB","EEE", 'A', Items.WHEAT, 'B', Items.BEURRE_MARRAKECH, 'E', Items.EGG});
        this.registerShapedRecipe(new ItemStack(Items.SPACE_CAKE_ITEM, 1), new Object [] {"CDC","BBB","ADA", 'A', Items.WHEAT, 'B', Items.BEURRE_MARRAKECH, 'C', Items.EGG, 'D', Items.MILK_BUCKET});
        this.registerShapedRecipe(new ItemStack(Items.BEURRE_MARRAKECH), new Object [] {" L ","OOO","WWW", 'L', Items.MILK_BUCKET, 'O', Items.EGG, 'W', Items.BEUH});
        this.registerShapedRecipe(new ItemStack(Items.JOINT, 1), new Object[] {"#CI", '#', Items.MASSA, 'C', Items.PURPLE, 'I', Items.TONK});
        this.registerShapedRecipe(new ItemStack(Items.PURPLE, 1), new Object[] {"###", "###", "###", '#', Items.PURPLE_TETE});
        this.registerShapelessRecipe(new ItemStack(Items.BITCOIN, 9), new Object[] {Items.DARK_BITCOIN});
        this.registerShapelessRecipe(new ItemStack(Items.BITCOIN_HALF, 9), new Object[] {Items.BITCOIN});
        this.registerShapedRecipe(new ItemStack(Items.IBOGAINE, 2), new Object[] {"#I", '#', Items.IBOGA_FRUIT, 'I', Items.FERMENTED_SPIDER_EYE});
        this.registerShapedRecipe(new ItemStack(Items.FLYING_MUSHROOM_STEW, 1), new Object[] {"#I", '#', Items.BOWL, 'I', Blocks.FLYING_MUSHROOM});
        this.registerShapedRecipe(new ItemStack(Items.ITEM_IBOGA_POTION, 1), new Object[] {"#I#", " G ", '#', Items.IBOGA_FRUIT, 'I', Items.IBOGAINE, 'G', Items.GLASS_BOTTLE});
        this.registerShapedRecipe(new ItemStack(Items.SALVIAX40, 1), new Object[] {"#I#", "IGI", "#B#", '#', Items.SALVIA_FLOWER, 'I', Items.GLOWSTONE_DUST, 'G', Items.DMT, 'B', Items.BOWL});
        this.registerShapedRecipe(new ItemStack(Items.CROUTE_DOOR, 3), new Object[] { "##", "##", "##", Character.valueOf('#'), Blocks.CROUTE_TERRESTRE});
        this.registerShapedRecipe(new ItemStack(Items.OBSI_DOOR, 3), new Object[] { "##", "##", "##", Character.valueOf('#'), Blocks.OBSIDIAN});
        this.registerShapedRecipe(new ItemStack(Items.OBSI_DOOR, 3), new Object[] { "##", "##", "##", Character.valueOf('#'), Blocks.OBSIRED});
        this.registerShapedRecipe(new ItemStack(Blocks.CROUTE_TERRESTRE, 1), new Object[] {"###", "###", "###", '#', Blocks.OBSIRED});	
        this.registerShapedRecipe(new ItemStack(Items.AMMO, 1), new Object[] {"#", "D", '#', Items.DOUILLE, 'D', Items.GUNPOWDER});
        
        
        this.registerShapedRecipe(new ItemStack(Items.TUSSIPAX_PILLS), new Object [] {"#","D", '#', Items.PAVOT_STACK, 'D', Items.ACETONE});
        this.registerShapedRecipe(new ItemStack(Items.PHENERGAN_PILLS), new Object [] {"#","D", '#', Items.GLOWSTONE_DUST, 'D', Items.ACETONE}); 
        this.registerShapedRecipe(new ItemStack(Items.LEANPLEINE), new Object [] {"#","D","S", '#', Items.PHENERGAN_PILLS, 'D', Items.TUSSIPAX_PILLS, 'S', Items.SPRITE});
        this.registerShapedRecipe(new ItemStack(Items.GRAPPIN), new Object [] {" D ","D#D"," # ", '#', Items.TITANE_STICK, 'D', Items.DARK_BITCOIN}); 
