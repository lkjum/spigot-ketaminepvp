...
public class PotionBrewer {
    ...
    public static final String extKetaEffect = "-0-1-2-3&2-2+6";
    public static final String mdcEffect = "-0-1+2+3&3+6";
    public static final String extBicarEffect = "+0+1+2+3&3-3+6";
    ...
    static {
        ...
        PotionBrewer.effectDurations.put(Integer.valueOf(MobEffectList.ANVIL.getId()), "!0 & !1 & 2 & 3 & 3+6");
        ...
        n = "+0+1-2+3&4-4+13";
        PotionBrewer.effectDurations.put(Integer.valueOf(MobEffectList.ABSORBTION.getId()), "0 & 1 & !2 & 3 & 3+6"); //jump
        j = "+5-6-7";
        
        
        PotionBrewer.effectDurations.put(Integer.valueOf(MobEffectList.FALL.getId()), "!0 & !1 & !2 & !3 & 2+6");
        PotionBrewer.effectAmplifiers.put(Integer.valueOf(MobEffectList.FALL.getId()), "5");
        
        PotionBrewer.effectDurations.put(Integer.valueOf(MobEffectList.RESISTANCE.getId()), "0 & 1 & 2 & 3 & 3+6");
        PotionBrewer.effectAmplifiers.put(Integer.valueOf(MobEffectList.RESISTANCE.getId()), "5");
 
        PotionBrewer.effectDurations.put(Integer.valueOf(MobEffectList.FASTER_DIG.getId()), "0 & 1 & 2 & !3 & 3+6");
        PotionBrewer.effectAmplifiers.put(Integer.valueOf(MobEffectList.FASTER_DIG.getId()), "5");
        
       // PotionBrewer.effectAmplifiers.put(Integer.valueOf(MobEffectList.ANVIL.getId()), "5");
        //PotionBrewer.effectDurations.put(Integer.valueOf(MobEffectList.ANVIL.getId()), "0 & 1 & 2 & 3 & 3+6");
        ...
        PotionBrewer.effectAmplifiers.put(Integer.valueOf(MobEffectList.ABSORBTION.getId()), "5"); //jump
        i = "-5+6-7";
        k = "+14&13-13";
        q = Maps.newHashMap();
