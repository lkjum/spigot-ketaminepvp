...
public class EntityCreeperRed extends EntityMonster {
	...
	public EntityCreeperRed(World world) {
        super(world);
        this.goalSelector.a(1, new PathfinderGoalFloat(this));
        this.goalSelector.a(2, new PathfinderGoalSwellRed(this));
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.31D);
    }
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource.getEntity() instanceof EntitySkeleton) {
            int i = Item.getId(Items.ITEM_IBOGA_POTION);
            int j = Item.getId(Items.TITANE_NUGGET);
            ...
            this.record = k;
            // CraftBukkit end
        } else if (damagesource.getEntity() instanceof EntityCreeperRed && damagesource.getEntity() != this && ((EntityCreeperRed) damagesource.getEntity()).isPowered() && ((EntityCreeperRed) damagesource.getEntity()).cp()) {
            ((EntityCreeperRed) damagesource.getEntity()).cq();
            // CraftBukkit start
            // this.a(new ItemStack(Items.SKULL, 1, 4), 0.0F);
            headDrop = new ItemStack(Items.SKULL, 1, 5);
            // CraftBukkit end
        }
    ...
    public void onLightningStrike(EntityLightning entitylightning) {
        ...
        // CraftBukkit start
        if (CraftEventFactory.callCreeperRedPowerEvent(this, entitylightning, org.bukkit.event.entity.CreeperRedPowerEvent.PowerCause.LIGHTNING).isCancelled()) {
            return;
        }
    ...
    private void cr() {
        if (!this.world.isClientSide) {
            ...
            float f = this.isPowered() ? 5.0F : 2.5F;
