...
public class ContainerDrugsWork extends Container {
    ...
    public ContainerDrugsWork(PlayerInventory playerinventory, World world, BlockPosition blockposition) {
        ...
        this.a((Slot) (new SlotResultKeta(playerinventory.player, this.craftInventory, this.resultInventory, 0, 124, 35)));
    ...
    public void a(IInventory iinventory) {
        ...
        // CraftBukkit start
        CraftingManagerKeta.getInstance().lastCraftView = getBukkitView();
        ItemStack craftResult = CraftingManagerKeta.getInstance().craft(this.craftInventory, this.g);
    ...
    public boolean a(EntityHuman entityhuman) {
        ...
        return this.g.getType(this.h).getBlock() != Blocks.DRUGS_WORK ? false : entityhuman.e((double) this.h.getX() + 0.5D, (double) this.h.getY() + 0.5D, (double) this.h.getZ() + 0.5D) <= 64.0D;
    }
