...
import net.minecraft.server.TileEntityChest.SyntheticClass_1;
// CraftBukkit end

public class TileEntityTitaneChest extends TileEntityContainer implements IUpdatePlayerListBox, IInventory {

    private ItemStack[] items = new ItemStack[36];
    public boolean a;
    public TileEntityTitaneChest f;
    public TileEntityTitaneChest g;
    public TileEntityTitaneChest h;
    public TileEntityTitaneChest i;
    public float j;
    public float k;
    public int l;
    private int n;
    ...
    private void a(TileEntityTitaneChest tileentitychest, EnumDirection enumdirection) {
    ...
    protected TileEntityTitaneChest a(EnumDirection enumdirection) {
        ...
        if (this.b(blockposition)) {
            ...
            if (tileentity instanceof TileEntityTitaneChest) {
                TileEntityTitaneChest tileentitychest = (TileEntityTitaneChest) tileentity;
    ...
    private boolean b(BlockPosition blockposition) {
        if (this.world == null) {
            ...
            return block instanceof BlockTitaneChest && ((BlockTitaneChest) block).b == this.n();
        }
    }
    ...
    public void closeContainer(EntityHuman entityhuman) {
        if (!entityhuman.isSpectator() && this.w() instanceof BlockTitaneChest) {
            int oldPower = Math.max(0, Math.min(15, this.l)); // CraftBukkit - Get power before new viewer is added
    ...
    public int n() {
        if (this.o == -1) {
            if (this.world == null || !(this.w() instanceof BlockTitaneChest)) {
                return 0;
            }

            this.o = ((BlockTitaneChest) this.w()).b;
        }
