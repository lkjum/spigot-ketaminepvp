...
public class ChunkProviderHell implements IChunkProvider {
    ...
    public ChunkProviderHell(World world, boolean flag, long i) {
        ...
        this.sheitan = new WorldGenMinable(Blocks.SHEITAN_ORE.getBlockData(), 8, BlockPredicate.a(Blocks.NETHERRACK));
        this.magma = new WorldGenMinable(Blocks.MAGMA.getBlockData(), 8, BlockPredicate.a(Blocks.NETHERRACK));
        this.obsired = new WorldGenMinable(Blocks.OBSIRED.getBlockData(), 10, BlockPredicate.a(Blocks.NETHERRACK));
        ...
        this.flymush = new WorldGenMushrooms(Blocks.FLYING_MUSHROOM);
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        if (this.j.nextBoolean()) {
            this.flymush.generate(this.h, this.j, blockposition.a(this.j.nextInt(16) + 8, this.j.nextInt(128), this.j.nextInt(16) + 8));
        }
        ...
        for (k = 0; k < 16; ++k) {
            this.sheitan.generate(this.h, this.j, blockposition.a(this.j.nextInt(16), this.j.nextInt(108) + 10, this.j.nextInt(16)));
        }
        for (k = 0; k < 16; ++k) {
            this.magma.generate(this.h, this.j, blockposition.a(this.j.nextInt(16), this.j.nextInt(108) + 10, this.j.nextInt(16)));
        }
        for (k = 0; k < 16; ++k) {
            this.obsired.generate(this.h, this.j, blockposition.a(this.j.nextInt(16), this.j.nextInt(108) + 10, this.j.nextInt(16)));
        }
