...
import net.minecraft.server.BlockFlowers.EnumFlowerVarient;
import net.minecraft.server.BlockStone.EnumStoneVariant;
import net.minecraft.server.CustomWorldSettingsFinal.CustomWorldSettings;
...
public class BiomeDecorator {
    ...
    protected int K;
    public boolean L;
    // KetaminePVP - add ore to generation
    protected WorldGenerator oreKeta;
    protected WorldGenerator oreCoke;
    protected WorldGenerator oreBitcoin;
    protected WorldGenerator oreBicarbonate;
    protected WorldGenerator oreDealOre;
    protected WorldGenerator oreEmrald;
    protected WorldGenerator fly;
    protected WorldGenerator segle;
    ...
    public BiomeDecorator() {
        ...
        this.fly = new WorldGenMushrooms(Blocks.FLYING_MUSHROOM);
        //this.segle = new WorldGenFlowers(Blocks.RED_FLOWER, EnumFlowerVarient.SEGLE);
        this.B = 2;
        this.C = 1;
        this.H = 1;
        this.I = 3;
    ...
    public void a(World world, Random random, BiomeBase biomebase, BlockPosition blockposition) {
        if (this.a != null) {
            ...
            this.oreKeta = new WorldGenMinable(Blocks.KETA_ORE.getBlockData(), 6);
            this.oreCoke = new WorldGenMinable(Blocks.COKE_ORE.getBlockData(), 4);
            this.oreBitcoin = new WorldGenMinable(Blocks.BITCOIN_ORE.getBlockData(), 4);
            this.oreBicarbonate = new WorldGenMinable(Blocks.BICARBONATE_ORE.getBlockData(), 8);
            this.oreDealOre = new WorldGenMinable(Blocks.DEALORE.getBlockData(), 4);
            this.oreEmrald = new WorldGenMinable(Blocks.EMERALD_ORE.getBlockData(), 4);
    ...
    protected void a(BiomeBase biomebase) {
        ...
        for (j = 0; j < this.E; ++j) {
            ...
            if (this.b.nextInt(8) == 0) {
                ...
                i1 = this.b.nextInt(this.getHighestBlockYAt(this.c.a(k, 0, l)).getY() * 2); // CraftBukkit - Prevent crash
                blockposition = this.c.a(k, i1, l);
                this.fly.generate(this.a, this.b, blockposition);
            }
        }
    ...
    protected void a() {
        ...
        this.a(4, oreCoke, 5, 45);
        this.a(6, oreKeta, 5, 75);
        this.a(8, oreBicarbonate, 5, 128);
        this.a(4, oreBitcoin, 5, 40);
        this.a(4, oreDealOre, 5, 20);
        this.a(6, oreEmrald, 5, 128);
    }
}
