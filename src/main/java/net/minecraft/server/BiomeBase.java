...
public abstract class BiomeBase {
    ...
    protected BiomeBase(int i) {
        ...
        this.au.add(new BiomeBase.BiomeMeta(EntityRoadrunner.class, 8, 4, 4));
        // this.au.add(new BiomeBase.BiomeMeta(EntityBear.class, 6, 2, 2));
        ...
        this.at.add(new BiomeBase.BiomeMeta(EntityCrackos.class, 25, 2, 2));
        this.at.add(new BiomeBase.BiomeMeta(EntityCreeperRed.class, 100, 4, 4));
        ...
        this.av.add(new BiomeBase.BiomeMeta(EntityDofin.class, 100, 4, 4));
