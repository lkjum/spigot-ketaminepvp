...
public class EntityDofin extends EntityWaterAnimal {
    ...
    public EntityDofin(World world) {
        super(world);
        this.setSize(1.5F, 0.8F);
        this.random.setSeed((long) (1 + this.getId()));
        this.bq = 1.0F / (this.random.nextFloat() + 1.0F) * 0.2F;
        this.goalSelector.a(0, new EntityDofin.PathfinderGoalSquid(this));
    }
    ...
    protected void dropDeathLoot(boolean flag, int i) {
        ...
        for (int k = 0; k < j; ++k) {
            this.a(new ItemStack(Items.DYE, 1, EnumColor.CYAN.getInvColorIndex()), 0.0F);
        }
    ...
    static class PathfinderGoalSquid extends PathfinderGoal {
        ...
        private EntityDofin a;

        public PathfinderGoalSquid(EntityDofin entitysquid) {
            this.a = entitysquid;
        }
