...
public class BlockFlowerPot extends BlockContainer {
    ...
    private boolean a(Block block, int i) {
        return block != Blocks.YELLOW_FLOWER && block != Blocks.RED_FLOWER && block != Blocks.CACTUS && block != Blocks.BROWN_MUSHROOM && block != Blocks.RED_MUSHROOM && block != Blocks.FLYING_MUSHROOM && block != Blocks.SAPLING && block != Blocks.DEADBUSH ? block == Blocks.TALLGRASS && i == BlockLongGrass.EnumTallGrassType.FERN.a() : true;
    }
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        if (tileentity instanceof TileEntityFlowerPot) {
            ...
            if (item instanceof ItemBlock) {
                ...
                }else if (block == Blocks.FLYING_MUSHROOM) {
                    blockflowerpot_enumflowerpotcontents = BlockFlowerPot.EnumFlowerPotContents.FLYING_MUSHROOM;
    ...
    public static enum EnumFlowerPotContents implements INamable {
        ...
        FLYING_MUSHROOM("flying_mushroom"),
