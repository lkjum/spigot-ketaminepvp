...
public abstract class World implements IBlockAccess {
    ...
    public Explosion explodeB(Entity entity, double d0, double d1, double d2, float f, boolean flag) {
        return this.createExplosionB(entity, d0, d1, d2, f, false, flag);
    }
    ...
    public Explosion createExplosionB(Entity entity, double d0, double d1, double d2, float f, boolean flag, boolean flag1) {
    	Explosion explosion = new Explosion(this, entity, d0, d1, d2, f, flag, flag1);
