...
public class TileEntityCokeBurner extends TileEntityContainer implements IUpdatePlayerListBox, IWorldInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.m : "container.coke_burner";
    }
    ...
    public void c() {
        boolean flag = (this.w() == Blocks.LIT_COKE_BURNER); // CraftBukkit - SPIGOT-844 - Check if furnace block is lit using the block instead of burn time // PAIL: Rename
        boolean flag1 = false;
        ...
        if (!this.world.isClientSide) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                BlockCokeBurner.a(this.isBurning(), this.world, this.position);
    ...
    public static int fuelTime(ItemStack itemstack) {
        if (itemstack == null) {
            ...
            return (item == Items.PETROLE ? 50000: 
            			(item == Items.COAL ? 400 : 
            		(item == Items.LAVA_BUCKET ? 10000 : 
            				(item == Item.getItemOf(Blocks.SAPLING) ? 10 : 
            					(item == Items.BLAZE_ROD ? 5000 : 0)))));
        }
    ...
    public boolean b(int i, ItemStack itemstack) {
        return i == 2 ? false : (i != 1 ? true : isFuel(itemstack) || SlotBurnerFuel.c_(itemstack)) || SlotBurnerFuel.isPetrole(itemstack);
    }

    public int[] getSlotsForFace(EnumDirection enumdirection) {
        return enumdirection == EnumDirection.DOWN ? TileEntityCokeBurner.f : (enumdirection == EnumDirection.UP ? TileEntityCokeBurner.a : TileEntityCokeBurner.g);
    }
    ...
    public Container createContainer(PlayerInventory playerinventory, EntityHuman entityhuman) {
        return new ContainerCokeBurner(playerinventory, this);
    }
