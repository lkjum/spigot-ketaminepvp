...
public class DispenserRegistry {
    ...
    static void b() {
        ...
        BlockDispenser.REGISTRY.a(Items.AMMO, new DispenseBehaviorProjectile() {
            protected IProjectile a(World world, IPosition iposition) {
                EntityAmmo entityarrow = new EntityAmmo(world, iposition.getX(), iposition.getY(), iposition.getZ());

                entityarrow.fromPlayer = 1;
                return entityarrow;
            }
        });
        BlockDispenser.REGISTRY.a(Items.ARROWFORCE, new DispenseBehaviorProjectile() {
            protected IProjectile a(World world, IPosition iposition) {
                EntityArrowForce entityarrow = new EntityArrowForce(world, iposition.getX(), iposition.getY(), iposition.getZ());

                entityarrow.fromPlayer = 1;
                return entityarrow;
            }
        });
        BlockDispenser.REGISTRY.a(Items.ARROWSPEED, new DispenseBehaviorProjectile() {
            protected IProjectile a(World world, IPosition iposition) {
                EntityArrowSpeed entityarrow = new EntityArrowSpeed(world, iposition.getX(), iposition.getY(), iposition.getZ());

                entityarrow.fromPlayer = 1;
                return entityarrow;
            }
        });
        BlockDispenser.REGISTRY.a(Items.ARROWPOISON, new DispenseBehaviorProjectile() {
            protected IProjectile a(World world, IPosition iposition) {
                EntityArrowPoison entityarrow = new EntityArrowPoison(world, iposition.getX(), iposition.getY(), iposition.getZ());

                entityarrow.fromPlayer = 1;
                return entityarrow;
            }
        });
        BlockDispenser.REGISTRY.a(Items.ARROWLENTEUR, new DispenseBehaviorProjectile() {
            protected IProjectile a(World world, IPosition iposition) {
                EntityArrowLenteur entityarrow = new EntityArrowLenteur(world, iposition.getX(), iposition.getY(), iposition.getZ());
        ...
        BlockDispenser.REGISTRY.a(Items.FLINT_AND_STEEL, new DispenseBehaviorItem() {
            ...
            protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                ...
                if (world.isEmpty(blockposition)) {
                    ...
                    world.setAir(blockposition);
                } else if (world.getType(blockposition).getBlock() == Blocks.AQUATNT) {
                    Blocks.AQUATNT.postBreak(world, blockposition, Blocks.AQUATNT.getBlockData().set(BlockAquaTNT.EXPLODE, Boolean.valueOf(true)));
                    world.setAir(blockposition);
                }
                else {
                    this.b = false;
        ...
        BlockDispenser.REGISTRY.a(Item.getItemOf(Blocks.AQUATNT), new DispenseBehaviorItem() {
            protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                World world = isourceblock.getWorld();
                BlockPosition blockposition = isourceblock.getBlockPosition().shift(BlockDispenser.b(isourceblock.f()));
                // EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(world, (double) blockposition.getX() + 0.5D, (double) blockposition.getY(), (double) blockposition.getZ() + 0.5D, (EntityLiving) null);
                ...
                EntityAquaTNTPrimed entitytntprimed = new EntityAquaTNTPrimed(world, event.getVelocity().getX(), event.getVelocity().getY(), event.getVelocity().getZ(), (EntityLiving) null);
                // CraftBukkit end
