...
public abstract class EntityLiving extends Entity {
    ...
    public boolean isCokeLadder() {
        int i = MathHelper.floor(this.locX);
        int j = MathHelper.floor(this.getBoundingBox().b);
        int k = MathHelper.floor(this.locZ);
        Block block = this.world.getType(new BlockPosition(i, j, k)).getBlock();

        return (block == Blocks.COKE_LADDER) && (!(this instanceof EntityHuman) || !((EntityHuman) this).isSpectator());
    }
    ...
    protected void bF() {
        ...
        if (this.hasEffect(MobEffectList.ANVIL)) 
        {
        	
        		this.motY += (double) ((float) (-0.001));
        		this.motX += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F);
        		this.motZ += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.5F);
        		this.motX -= (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F);
        		this.motZ -= (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F);
        		this.pitch += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F); 
        		this.yaw += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F); 
        		this.motY += (double) ((float) (0.001));
        		this.motX += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F);
        		this.motZ += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F);
        		this.pitch += (double) ((float) (this.getEffect(MobEffectList.ANVIL).getAmplifier() + 1) * 0.2F); 
    ...
    public void g(float f, float f1) {
        ...
        if (this.bM()) {
            ...
            if (this.V() && (!(this instanceof EntityHuman) || !((EntityHuman) this).abilities.isFlying)) {
                ...
                f3 = 0.8F;
                f4 = 0.02F;
                f2 = (float) EnchantmentManager.getDeth(this);
                if (f2 > 3.0F) {
                    f2 = 3.0F;
                }
            ...
            {
                d0 = this.locY;
                //Enchantement LavaWalker lkjum
                float f9 = 0.8F;
                float f10 = 0.02F;
                float f11 = (float) EnchantmentManager.getDeth(this);
                if (f11 > 3.0F) {
                    f11 = 3.0F;
                }
                ...
                if (f11 > 0.0F) {
                    f9 += (0.54600006F - f9) * f11 / 3.0F;
                    f10 += (this.bI() * 1.0F - f10) * f11 / 3.0F;
                }
    ...
    public void receive(Entity entity, int i) {
        if (!entity.dead && !this.world.isClientSide) {
            ...
            if (entity instanceof EntityArrowForce) {
                entitytracker.a(entity, (Packet) (new PacketPlayOutCollect(entity.getId(), this.getId())));
            }
            if (entity instanceof EntityArrowSpeed) {
                entitytracker.a(entity, (Packet) (new PacketPlayOutCollect(entity.getId(), this.getId())));
            }
            if (entity instanceof EntityArrowPoison) {
                entitytracker.a(entity, (Packet) (new PacketPlayOutCollect(entity.getId(), this.getId())));
            }
            if (entity instanceof EntityArrowLenteur) {
                entitytracker.a(entity, (Packet) (new PacketPlayOutCollect(entity.getId(), this.getId())));
            }
            if (entity instanceof EntityAmmo) {
                entitytracker.a(entity, (Packet) (new PacketPlayOutCollect(entity.getId(), this.getId())));
            }
