...
public class MobEffectList {
    ...
    public static final MobEffectList[] byId = new MobEffectList[33];
    ...
    public static final MobEffectList FALL = (new MobEffectList(24, new MinecraftKey("PotionFall"), false, 3426654)).c("potion.fall").b(3, 2);
    public static final MobEffectList ANVIL = (new MobEffectList(25, new MinecraftKey("anvil"), true, 13238016)).c("potion.maldecrane");
    public final int id;
    ...
    public void tick(EntityLiving entityliving, int i) {
       ...
       /* else if (this.id == MobEffectList.ANVIL.id) {
        	//DamageSource armor = null;
