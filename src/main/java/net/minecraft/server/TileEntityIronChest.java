...
public class TileEntityIronChest extends TileEntityContainer implements IUpdatePlayerListBox, IInventory {

    private ItemStack[] items = new ItemStack[54];
    public boolean a;
    public TileEntityIronChest f;
    public TileEntityIronChest g;
    public TileEntityIronChest h;
    public TileEntityIronChest i;
    public float j;
    public float k;
    public int l;
    private int n;
    ...
    private boolean b(BlockPosition blockposition) {
        if (this.world == null) {
            ...
            return block instanceof BlockIronChest && ((BlockIronChest) block).b == this.n();
        }
    }
        ...
        if (!this.world.isClientSide && this.l != 0 && (this.n + i + j + k) % 200 == 0) {
            ...
            /*while (iterator.hasNext()) {
                ...
                if (entityhuman.activeContainer instanceof ContainerChest) {
                    ...
                    ++this.l;
                    if (iinventory == this || iinventory instanceof InventoryIronChest && ((InventoryIronChest) iinventory).leftOrRight((IInventory) this)) {
                        ++this.l;
                    }
                }
            }*/
    ...
    public void closeContainer(EntityHuman entityhuman) {
        if (!entityhuman.isSpectator() && this.w() instanceof BlockIronChest) {
            int oldPower = Math.max(0, Math.min(15, this.l)); // CraftBukkit - Get power before new viewer is added
    ...
    public int n() {
        if (this.o == -1) {
            if (this.world == null || !(this.w() instanceof BlockIronChest)) {
                return 0;
            }

            this.o = ((BlockIronChest) this.w()).b;
        }
