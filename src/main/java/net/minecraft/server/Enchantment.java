...
public abstract class Enchantment {
    ...
    public static final Enchantment KHOLE = new EnchantmentKhole(22, new MinecraftKey("khole"), 5, 0);
    public static final Enchantment TRAMA = new EnchantmentTrama(23, new MinecraftKey("trama"), 5, 0);
    public static final Enchantment LAVA_WALKER = new EnchantmentLavaWalker(24, new MinecraftKey("lava_walker"), 2);
    public static final Enchantment FARM_TOOL = new EnchantmentFarmtool(36, new MinecraftKey("farm_loot"), 1);
    public static final Enchantment HAMMER = new EnchantmentHammer(37, new MinecraftKey("hammer"), 1);
    public final int id;
