...
public class EntityArrowLenteur extends Entity implements IProjectile {
    ...
    public EntityArrowLenteur(World world) {
        super(world);
        this.j = 10.0D;
        this.setSize(0.5F, 0.5F);
    }

    public EntityArrowLenteur(World world, double d0, double d1, double d2) {
        super(world);
        this.j = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityArrowLenteur(World world, EntityLiving entityliving, EntityLiving entityliving1, float f, float f1) {
        super(world);
        this.j = 10.0D;
    ...
    public EntityArrowLenteur(World world, EntityLiving entityliving, float f) {
        super(world);
        this.j = 10.0D;
        this.shooter = entityliving;
        this.projectileSource = (LivingEntity) entityliving.getBukkitEntity(); // CraftBukkit
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                ...
                if (movingobjectposition.entity != null) {
                    //
                	movingobjectposition.entity.addEffect(new MobEffect(MobEffectList.SLOWER_MOVEMENT.id, 300, 1));
                	//
                    ...
                    if (this.shooter == null) {
                        damagesource = DamageSource.arrowLenteur(this, this);
                    } else {
                        damagesource = DamageSource.arrowLenteur(this, this.shooter);
                    }
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide && this.inGround && this.shake <= 0) {
            ...
            if (this.fromPlayer == 1 && !entityhuman.inventory.pickup(new ItemStack(Items.ARROWLENTEUR, 1))) {
                flag = false;
            }
