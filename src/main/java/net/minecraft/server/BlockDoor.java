        		...
        		(this == Blocks.BIRCH_DOOR ? Items.BIRCH_DOOR : 
        			(this == Blocks.JUNGLE_DOOR ? Items.JUNGLE_DOOR : 
        				(this == Blocks.ACACIA_DOOR ? Items.ACACIA_DOOR : 
        					(this == Blocks.CROUTE_DOOR_BLOCK ? Items.CROUTE_DOOR : 
        						(this == Blocks.OBSI_DOOR_BLOCK ? Items.OBSI_DOOR : 
        							(this == Blocks.DARK_OAK_DOOR ? Items.DARK_OAK_DOOR : Items.WOODEN_DOOR)))))));
    }
