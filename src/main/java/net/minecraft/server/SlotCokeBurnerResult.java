...
public class SlotCokeBurnerResult extends Slot {

    private EntityHuman a;
    private int b;

    public SlotCokeBurnerResult(EntityHuman entityhuman, IInventory iinventory, int i, int j, int k) {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            TileEntityCokeBurner furnace = ((TileEntityCokeBurner) this.inventory);
