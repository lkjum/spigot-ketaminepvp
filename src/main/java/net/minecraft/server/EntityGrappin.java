...
public class EntityGrappin extends Entity {
    ...
    public EntityGrappin(World world, EntityHuman entityhuman) {
        super(world);
        this.ah = true;
        this.owner = entityhuman;
        this.owner.grappened = this;
        this.setSize(0.25F, 0.25F);
    ...
    public void t_() {
        ...
        if (this.az > 0) {
            ...
            if (!this.world.isClientSide) {
                ...
                if (this.owner.dead || !this.owner.isAlive() || itemstack == null || itemstack.getItem() != Items.GRAPPIN || this.h(this.owner) > 1024.0D) {
                    this.die();
                    this.owner.grappened = null;
                    return;
                }
    ...
    public int l() {
        if (this.world.isClientSide) {
            ...
            if (this.hooked != null) {
            	...
            	//org.bukkit.Location location = ((org.bukkit.entity.Entity) this.hooked).getLocation();
            	//PlayerTeleportEvent teleEvent = new PlayerTeleportEvent((Player) this.owner, ((org.bukkit.entity.Entity) this.owner).getLocation(), location, PlayerTeleportEvent.TeleportCause.GRAPPIN);
            	//this.owner.playerConnection.teleport(teleEvent.getTo());
            	this.owner.enderTeleportTo(this.hooked.locX, this.hooked.locY, this.hooked.locZ);
