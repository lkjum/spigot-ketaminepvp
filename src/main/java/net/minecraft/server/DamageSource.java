...
public class DamageSource {
    ...
    public static DamageSource ammo(EntityAmmo entityammo, Entity entity) {
        return (new EntityDamageSourceIndirect("ammo", entityammo, entity)).b();
    }
    
    public static DamageSource arrowForce(EntityArrowForce entityarrow, Entity entity) {
        return (new EntityDamageSourceIndirect("arrowForce", entityarrow, entity)).b();
    }
    public static DamageSource arrowSpeed(EntityArrowSpeed entityarrow, Entity entity) {
        return (new EntityDamageSourceIndirect("arrowSpeed", entityarrow, entity)).b();
    }
    public static DamageSource arrowPoison(EntityArrowPoison entityarrow, Entity entity) {
        return (new EntityDamageSourceIndirect("arrowPoison", entityarrow, entity)).b();
    }
    public static DamageSource arrowLenteur(EntityArrowLenteur entityarrow, Entity entity) {
        return (new EntityDamageSourceIndirect("arrowLenteur", entityarrow, entity)).b();
    }
    ...
    public static DamageSource explosion(ExplosionB explosion) {
        return explosion != null && explosion.c() != null ? (new EntityDamageSource("explosion.player", explosion.c())).q().d() : (new DamageSource("explosion")).q().d();
    }
