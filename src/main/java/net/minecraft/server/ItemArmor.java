...
public class ItemArmor extends Item {
    ...
    static final int[] k = new int[] { 11, 16, 15, 13};
    ...
    public int c;
    public int d;
    private ItemArmor.EnumArmorMaterial m;
    ...
    public static enum EnumArmorMaterial {
        ...
        KETAMINERAI("ketaminerai", 60, new int[] {3, 8, 6, 3}, 10),
        COKE("coke", 80, new int[] {4, 8, 6, 4}, 10),
        BITCOIN("bitcoin", 100, new int[] {5, 8, 6, 5}, 10),
        DARK_BITCOIN("dark_bitcoin", 120, new int[] {6, 8, 6, 6}, 10),
        TITANE("titane", 135, new int[] {6, 8, 7, 6}, 10),
    	MDMA("mdma", 150, new int[] {7, 8, 7, 7}, 10),
    	
        RENFO_KETA("titane_keta", 160, new int[] {7,8,8,7}, 10),
        RENFO_COKE("titane_coke", 170, new int[] {7,9,8,7}, 10),
        RENFO_MDMA("titane_mdma", 180, new int[] {8,9,9,8}, 10),
        TITANE_SUP("titane_sup", 200, new int[] {8,10,10,8}, 15);
            		...
            		(this == ItemArmor.EnumArmorMaterial.GOLD ? Items.GOLD_INGOT : 
            			(this == ItemArmor.EnumArmorMaterial.IRON ? Items.IRON_INGOT : 
            				(this == ItemArmor.EnumArmorMaterial.DIAMOND ? Items.DIAMOND : 
            					(this == ItemArmor.EnumArmorMaterial.KETAMINERAI ? Items.KETAMINERAI : 
            						(this == ItemArmor.EnumArmorMaterial.COKE ? Items.PAIN2C : 
            							(this == ItemArmor.EnumArmorMaterial.BITCOIN ? Items.BITCOIN :
            								(this == ItemArmor.EnumArmorMaterial.DARK_BITCOIN ? Items.DARK_BITCOIN :
            									(this == ItemArmor.EnumArmorMaterial.TITANE ? Items.TITANE :
            										(this == ItemArmor.EnumArmorMaterial.MDMA ? Items.MDMA :
            											(this == ItemArmor.EnumArmorMaterial.RENFO_KETA ? Items.TIKETA :
            												(this == ItemArmor.EnumArmorMaterial.RENFO_COKE ? Items.TICOKE :
            													(this == ItemArmor.EnumArmorMaterial.RENFO_MDMA ? Items.TIMDMA :
            														(this == ItemArmor.EnumArmorMaterial.TITANE_SUP ? Items.TISUP :
            										null))))))))))))));
        }
    }
}
